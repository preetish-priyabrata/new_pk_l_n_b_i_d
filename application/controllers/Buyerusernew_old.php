...
EOT;
    ...
    public function Buyer_add_new_pr_tech_comm_save_arr(){
        ...
        //report new added dates technocomm
          ...
          $data_master_dates = array('planned_technical_clearance_date' =>$planned_technical_clearance_date, 'actual_technical_clearance_date'=> $actual_technical_date, 'commercial_closure_date' =>$commercial_closure_date, 'delivery_date_as_per_po'=> $delivery_date_as_per_po, 'drg_submission_date'=> $drg_submission_date);
       ...
       $bid_Id=$bid_ref_no=$this->input->post('bid_ref_no');
        ...
        $unit_price=$this->input->post('unit_price');
          ...
          //report new added dates comm
           ...
           $data_master_dates_comm = array('planned_technical_clearance_date' =>$planned_technical_clearance_date, 'actual_technical_clearance_date'=> $actual_technical_date, 'commercial_closure_date' =>$commercial_closure_date, 'delivery_date_as_per_po'=> $delivery_date_as_per_po, 'drg_submission_date'=> $drg_submission_date);
