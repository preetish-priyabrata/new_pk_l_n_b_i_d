...
<div class="row align-items-center h-100">
    <div class="col-3 mx-auto">
        <div class="text-center">
            ...
            <form action="login_process" method="POST" class="form-signin">
                
            	<input type="text" name="UserId" id="UserId" class="form-control form-group" placeholder="UserId" required autofocus>
