												...
												<td>
													<strong>
														...
														if($approval_status==1){
															...
															if($submitted_status==1){ ?> <a target="_blank" href="<?=base_url().'seller/vendor-tech-file-new-bid-submission-info/'.$value.'/'.$submission->token_no .'/'.$submission->master_bid_id ?>">View Send </a><?php  }else{?> <a target="_blank" href="<?=base_url().'seller/user-vendor-tech-bid-submission-tokens-info/'.$value.'/'.$submission->token_no .'/'.$submission->master_bid_id ?>">Click View</a><?php }
														}
														?>
												 	</strong>
												</td>
