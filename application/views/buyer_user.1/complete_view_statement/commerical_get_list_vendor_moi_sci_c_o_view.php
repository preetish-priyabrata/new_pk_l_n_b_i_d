			                        ...
			                        <?php 
										...
										?>
													...
													<!--GST Type -->
														<tr>   
															<th></th>                         	
															<th colspan="3"><strong>GST Type</strong></th> 
															<?php 
																foreach ($final_id_vendor as $key_ven_id =>$userid_ven) {
																	$id_count=$times_repeat[$userid_ven];
...
<!--CGST -->
	<tr>   
		<th></th>                         	
		<th colspan="3"><strong>CGST</strong></th> 
		<?php 
			foreach ($final_id_vendor as $key_ven_id =>$userid_ven) {
				$id_count=$times_repeat[$userid_ven];
...
<tr>   
		<th></th>                         	
		<th colspan="3"><strong>SGST</strong></th> 
		<?php 
			foreach ($final_id_vendor as $key_ven_id =>$userid_ven) {
				$id_count=$times_repeat[$userid_ven];
...
<tr>   
		<th></th>                         	
		<th colspan="3"><strong>IGST</strong></th> 
		<?php 
			foreach ($final_id_vendor as $key_ven_id =>$userid_ven) {
				$id_count=$times_repeat[$userid_ven];
