			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<a href="<?=base_url()?>design-new-material-catergory-new/1" class="btn btn-info fa fa-puzzle-piece " role="button" title="Here new Category is been created">Add New Material Category</a>
					</div>
					<br>
					<br>
					        		...
					        		foreach ($query->result() as $value) {
					        			...
					        			<tr>
							                ...
							                <td><?=ucfirst($value->category_name)?></td>
							               	<td><a href="<?=base_url()?>design-view-material-more/<?=$value->category_name?>">Click For More</a></td>
