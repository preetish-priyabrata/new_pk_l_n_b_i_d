...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Create New PR Requisition</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Add New PR Requisition Information</h4>
				</div>
					...
					<div class="alert alert-secondary">
						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group row m-b-15">
									<label class="col-form-label col-md-3" for="Revised_required_date">Revised Date</label>
									<div class="col-md-9">
										<input class="form-control m-b-5 datepickers" placeholder="Enter Revised Date  " name="Revised_required_date" id="Revised_required_date" type="text" >
										<small class="f-s-12 text-grey-darker">Please enter Revised Date </small>
									</div>
								</div>
								<div class="form-group row m-b-15">
