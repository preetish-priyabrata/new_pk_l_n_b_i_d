...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Complete Commercial Bid details </li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">View details of Complete Commercial Bids</h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title"> Complete Commercial Bids details </h4>
				</div>
