...
$result_drafted_bid_details_vendor = $this->buyer_user->vendor_approved_buyer_technical($mr_no);
foreach ($result_drafted_bid_details_vendor['bid_query_list'] as $key) {
	// print_r($key);
									                        ...
									                        <tbody>
									                            ...
									                            if($get_list_vendors['No_vendors']==1){
										                            foreach($get_list_vendors['vendors_lists'] as $key_vendors){ 
										                            	...
										                            	?>
										                                <tr>
										                                    <td><input type="checkbox" checked="" readonly="" name="vendor_array[]" value="<?=$key_vendors->Vendor_email_id?>"></td>
										                                    <td>
