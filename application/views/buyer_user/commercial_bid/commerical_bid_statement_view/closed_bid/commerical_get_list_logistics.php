...
//
	...
	$query_summary_filter_exe=$this->db->get_where('master_final_closed_bid_logistics',$query_summary_filter);
                        ...
                        <tbody>
                        	...
                        	$x=0;
                        		foreach ($query_get_list->result() as $key_value) {
                        			// print_r($key_value);
                        			$slno_mat=$key_value->Slno_logic_comm;
                        		$x++;
                        		?>
                        		...
                        		<tr>
								   ...
								   <td><?=$key_value->vehicle_nos?></td>
						 			...
						 			foreach ($final_id_vendor as $key_ven_id =>$userid_ven) {
						 				...
						 				$data_ve_item=$this->db->get_where('master_closed_bid_logistics',$date_im);
						 				?>
						 				<td>
						 							...
						 							<tr>
						 								...
						 								<th>
								 							...
								 							foreach ($data_ve_item->result() as $key_item => $value_item) {
								 								...
								 								echo "<th width='25%'>".$value_item->unit_price."</th>";
								 								echo "<th width='25%'>".$value_item->total_unit_price."</th>";
