...
$result_drafted=$this->buyer_user->drafted_bid_information_commerical_completed($email_id,6,'');
...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Completed Bid Information</a></li>
				<li class="breadcrumb-item active">completed Bid Information of Commercial</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Information Of Commercial Bid</h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Bid Information</h4>
				</div>
