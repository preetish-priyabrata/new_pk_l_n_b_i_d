...
<div id="content" class="content">
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item active">View Material List</li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">View Material List </h1>
	<!-- end page-header -->
...
?>
	<div class="panel panel-inverse">
		<div class="panel-heading">
			...
			<h4 class="panel-title">Material List</h4>
		</div>
		<div class="panel-body">

			<div class="pull-right">
				<a href="<?= base_url() ?>buyer-new-material-catergory/2" class="btn btn-info fa fa-puzzle-piece " role="button" title="Here New Material List is been created">Add New Material List</a>
			</div>
			<br>
			<br>
