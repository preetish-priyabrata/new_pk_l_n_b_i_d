		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Upload Material  </h4>
				</div>				
				<div class="panel-body">
					<div class="form-group row pull-right">
			             <div class="form-group row pull-right">
			                <div class="col-md-12">
								<a href="<?=base_url()?>buyer-user-add-new-material" class="btn btn-sm btn-default" onclick="new_material_Popup(this.href,'myWindow','900','600','yes');return false">Add New Single Material</a>
							</div>
						</div>
					</div>
					<br>
...
$(document).ready(function(){
	...
	$('#sub').on('click', function () {
		if (document.getElementById('job_files').value !== '') {
        	...
        	var actions_file='buyer_files_uploaded_details';
            ...
            var file_data = $('#job_files').prop('files')[0];           
	            ...
	            if(file_data!=""){
	                ...
	                $.ajax({
	                    url: '<?php echo base_url(); ?>buyer-excel-upload/entry', // point to server-side controller method
...
function load_data(){
    ...
    queryString_id = 'actions_file='+actions_file;
			...
			$.ajax({
				url:"<?php echo base_url(); ?>buyer-excel-upload/entry",
				data:queryString_id,
				method:"POST",
