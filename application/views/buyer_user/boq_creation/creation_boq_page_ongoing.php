...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Create Boq Form </h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">				
					...
					<br>
					<br>
					<form action="<?=base_url()?>buyer-add-new-pr-save-ongoing" method="POST" >
 ...
 $('#search_button').click(function(){
        ...
        //Carry out a GET Ajax request using JQuery
	        $.ajax({
	            ...
	            url: '<?=base_url()?>buyer-material-search-get-ongoing',
	            method: 'post',
	            data: {
	                name: employee_name,
	                type: materials_id
...
var queryString = "";
	if(action != "") {
		switch(action) {
			...
			var price=$("#ptice_"+item_codes_order).val();
				queryString = 'action='+action+'&code='+ item_codes_order+'&quantity='+quantity+'&price='+price;
	...
	jQuery.ajax({
	url: "<?=base_url()?>buyer-ajax-cart-new-services-ongoing",
	data:queryString,
	type: "POST",
