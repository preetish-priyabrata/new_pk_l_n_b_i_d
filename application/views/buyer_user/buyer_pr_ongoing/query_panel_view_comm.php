...
$pr_no=$pr_no;
$result_query1=$this->db->get_where('master_bid_query_comm_m',array('pr_no'=>$pr_no,'Slno_query'=>$Slno_query));
...
<!-- Query Block End  -->
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
						<form  action="<?=base_url()?>buyer-commercial-query-view-save" method="post">
						<div class="row">
