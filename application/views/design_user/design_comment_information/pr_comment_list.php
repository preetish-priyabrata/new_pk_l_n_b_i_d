...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">View Project PR Schedule Comments
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
                    ...
                    <tr>
						...
						<th>Comment from Approver User</th>              
						<th>Status</th>
					...
					<?php
					 foreach($query->result() as $row){
						...
						$result_comm=$query_comment->result();
					 	$data_check=array('pr_no'=>$pr_no,'design_user_id'=>$email_id,'approver_user_status'=>0,'design_user_status'=>4);
					 		...
					 		switch ($design_user_status) {
					 			...
					 			case '4': // resubmission
					 				$status_detai="Resubmitted";
					 					$url='<a href="'.base_url().'design-mr-view-pr/'.$row->pr_no.'/'.$row->slno.'/'.$row->job_code.'/4" > Click to Resubmit</a>';
					 				break;
