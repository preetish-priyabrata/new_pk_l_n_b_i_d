...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="<?=base_url()?>design-view-new-uom-list">View UOM List</a></li>
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<form action="<?=base_url()?>design-view-new-material-uom-save" method="POST" >
							...
							<div class="form-group row pull-right">
			                    <div class="form-group row pull-right">
			                        <div class="col-md-12">
			                           ...
			                           <a href="<?=base_url()?>design-view-new-uom-list" class="btn btn-md btn-info fa fa-angle-left"   role="button"><i class=""></i> Back</a>
			                           
			                          <a href="<?=base_url()?>user-design-home" class="btn btn-md btn-success fa fa-angle-left"   role="button"><i class=""></i> Home</a>
			                        </div>
			                    </div>			
							</div>
						</div>
