...
<div class="sidebar-bg"></div>		<!-- end #sidebar -->
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li class="breadcrumb-item active"><a href="user-design-home" class="fa fa-home ">Home</a></li>
						...
						<div class="row"> -->
							<div class="col-md-4 col-md-offset-4 text-center">
								<!-- <div class="search-box">
									...
									<form action="<?=base_url()?>design-change-password-module-save" class="loginForm" method="post">
										...
										<div class="form-group row pull-right">
											<div class="col-md-12">
												...
												<a  href="user-design-home" class="btn btn-sm btn-default">Cancel</a> 
											</div>
										</div>
