...
?>
<style type="text/css">
	.form-control[required], .form-control[readonly], fieldset[required] .form-control {
    background: #fff;
    opacity: 0.9;
    color: blue;
}
...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header"> Job Code  <?=urldecode ($job_Code)?> </h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
                    ...
                    <h4 class="panel-title">Edit Project Information</h4>
				</div>
				<div class="panel-body">
					
					<form action="<?=base_url()?>admin-add-assign-user-to-project-save"   id="project_code_form" method="POST" >
						...
						<div class="row">
									<div class="col-md-6 col-lg-6">
									 	<div class="form-group row m-b-15">
											...
											<div class="col-md-9">
												<input class="form-control m-b-5" value="<?=$row->Project_Name?>" name="Project_name" id="Project_name" required="" type="text" >
										...
										<div class="form-group row m-b-15">
											...
											<div class="col-md-9">
												<input class="form-control m-b-5" value="<?=$row->job_Code?>" name="job_code" id="job_code"  required="" type="text" >	
									...
									<div class="col-md-6 col-lg-6">
									 	<div class="form-group row m-b-15">
											...
											<div class="col-md-9">
												<input class="form-control m-b-5" value="<?=$row->Customer_Name?>" name="Customer_name" required="" type="text">
										...
										<!-- <div class="form-group row m-b-15">
											...
											<div class="col-md-9">
												<input class="form-control m-b-5" value="<?=$row->Customer_Mobile_No?>" required="" type="text" >
										...
										<div class="form-group row m-b-15">
											...
											<div class="col-md-9">
												<textarea class="form-control" rows="3" name="Project_Description" required=""><?=$row->project_Description?></textarea>
