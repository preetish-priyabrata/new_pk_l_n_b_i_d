...
// 
// 
// master_pr_process_detail
$data_table_process=array('pr_no'=>$pr_no);
$query_data_process=$this->db->get_where('master_pr_process_detail',$data_table_process);

$results_process=$query_data_process->result();
...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">PR Informations  </h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Approved PR detail Informations</h4>
				</div>
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<div class="radio radio-css radio-inline">
										  <input type="radio" id="inlineCssRadio2" name="type_action"  value="1"  required="" checked="" />
										...
										<select name="Procurement" class="form-control m-b-5" id="Procurement" required="" >
											...
											if($data_array_procurement['no_user']==2){?>
												...
												foreach ($data_array_procurement['user_approver'] as $key_procurement) {
													if($results_process[0]->procurement_user_id_slno==$key_procurement->slno){
