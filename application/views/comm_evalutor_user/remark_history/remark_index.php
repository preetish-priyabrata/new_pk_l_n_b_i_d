                ...
                <tbody>
					<?php
					 foreach($query->result() as $row){
					 	$pr_no=$row->pr_no;
                        $url='<a href="'.base_url().'comm-pr-remark-history/'.$row->pr_no.'/'.$row->slno.'/'.$row->job_code.'/1"> Click View Remark</a>';
		                    echo '
		                    <tr>
					...
					<div class="form-group row pull-right">
                            <div class="col-md-12">
                                ...
                                <a  href="<?=base_url()?>user-commerical-evalutor-home" class="btn btn-sm btn-default btn-success">Back</a> 
                            </div>
                        </div>
				</div>
			</div>
