                  ...
                  <tr>
									...
									<tr>
										...
										<td>
											...
											<?php 
												foreach ($final_id_vendor as $key_ven_id =>$userid_ven) {
													...
													$query_vendor_result=$query_vendor->result();
													$value_id_vender=$query_vendor_result[0];
													echo "<option value=".$userid_ven.">".$value_id_vender->Organisation_name."</option>";
												}
											?>
											</select>
										</td>
										...
										<?php 
											foreach ($data_ve_item->result() as $key_item => $value_item) {
												echo "<td width='25%'>".number_format($value_item->Unit_price)."</td>";
												// echo "<th width='25%'>".$value_item->Unit_price."</th>";
												echo "<td width='25%'>".number_format($value_item->Total_unitprice)."</td>";
											}
										endforeach;
										?>
									</tr>
							...
							<tr>
								...
								?>
															<td width="25%"></td>
															<!-- <th width="25%"></th> -->
															<td width="25%"><?=number_format($value_short->sub_total)?></td>
								<?php 
											}
										}
								?>
							...
							<tr>
									...
									?>
										...
										<?php
													...
													?>
															<td width="25%"></td>
															<!-- <td width="25%"></td> -->
															<td width="25%"><?=number_format($value_total->total_price)?></td>
											<?php 
														}
																		...
																		<td width="25%">
																			<?php 
																					...
																					if(!empty($total_gst_value)){
																						echo number_format($total_gst_value);
																					}else{
																						echo "--";
																					}
																			?>
								...
								<tr>
									...
									<tr>
										...
										?>
													<td width="25%"></td>
													<td width="25%"><?=$value_delivery->field_value?></td>
									<?php }
											}
										?>
									</tr>
									...
									<tr>
										...
										?>
												...
												<td width="25%"><?=$value_security->field_value?></td> 
										<?php }
											}
										?>
									</tr><!-- Payment Terms -->
									<tr>
										...
										?>
														<td width="25%"></td>
														<td width="25%"><?=$value_payment->field_value?></td>
										<?php }
												}
										?>
									</tr><!-- Liquidity Damage -->
									<tr> 
										...
										?>
											...
											?>
														<td width="25%"></td> 
														<!-- <td width="25%"></td>  -->
														<td width="25%"><?=$value_liquidity->field_value?></td> 
										<?php }
											}
										?>
									</tr>
									...
									<tr>
										...
										?>			<td width="25%"></td>
														<td width="25%"><?=$value_validity->field_value?></td>
										<?php }
											}
										?>
									</tr>
									...
									<tr> 
										...
										?>
													<td width="25%"></td> 
													<td width="25%"><?=$value_gaurantee->field_value?></td> 
										<?php }
											}
										?>
									</tr>
									...
									?>
													<td width="25%"></td>
													<td width="25%"><?=$value_remarks->field_value?></td> 
								<?php }
										}
								?>
								</tr>
