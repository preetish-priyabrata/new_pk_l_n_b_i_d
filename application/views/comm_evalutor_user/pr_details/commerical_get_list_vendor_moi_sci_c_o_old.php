...
$get_bid  = array('Slno_bid' =>$comm_bid_db);
$bid_table=$this->db->get_where('master_bid_Com_m',$get_bid);
...
$value_bid_dates=$result_table1[0];
...
// $value_bid_details=$result_table12[0];
...
$get_rank=array();
			...
			$query_bid_sub=$this->db->get_where('master_pr_bid_qoute_item_total',$data);
