...
$access=$access; // here accress to user
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control-plaintext m-b-5 datepickers" placeholder="EnterBid Clearfication Date" name="date_clearfication_bid" id="date_clearfication_bid" type="text" required="" value="<?=date('d-m-Y',strtotime($value_bid_dates->bid_query_closed_date))?>">
