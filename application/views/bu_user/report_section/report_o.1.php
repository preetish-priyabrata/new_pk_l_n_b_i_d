								 	...
								 	<div class="form-group row m-b-15">
										...
										<div class="col-md-9">
											<select class="form-control"  name="slno_master_item" id="slno_master_item" required="">
												...
												?>
														<option value='<?=$value->slno_master_item?>' <?php if($slno_master_item==$value->slno_master_item){ echo "selected";}?>><?=$value->material_item_name." [ ".$value->material_item_id." ]"?></option>
												<?php 	}
												?>
											</select>
