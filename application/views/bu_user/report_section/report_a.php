...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Report on PR release Status of a Project: “Planned Vs Actual” </li> 
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h3 class="page-header">Report on PR release Status of a Project:<br> “Planned Vs Actual” <small></small></h3>
			<!-- end page-header -->
		...
		<script type="text/javascript">
		    ...
		    function drawChart() {
		      var data = google.visualization.arrayToDataTable([
		        ...
		        ['No. of PRs Planned',     <?=$total_pr?> , "blue"],
				['No. of PRs Released',      <?=$comp?>, "#11bbf9"],
				['No. of PRs Not Released',  <?=$incom?>, "red"],
				
				['NO of Actual order settlement',    <?=$commercial_count?>,"color: green"]
		      ...
		      var options = {
		        title: "Report on PR release Status of a Project: “Planned Vs Actual”  \n Project Name :- <?=$project_details_info?>",
