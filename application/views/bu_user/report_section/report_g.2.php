...
<div class="sidebar-bg"></div>
										...
										<div class="col-md-9">
                                            <select name="buyer_id" class="form-control m-b-5" id="buyer_id"  required="" >
                                                ...
                                                ?>
													...
													<option value='<?=$key_buyer->slno?>' <?php if($buyer_id_new==$key_buyer->slno){ echo "selected"; }?>
                                                        ><?=$key_buyer->Username." [ ".$key_buyer->email_id." ]"?></option>
                                                <?php 
												    }
												?>
											</select>
        ...
        <?php 
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">					
					<h4 class="panel-title"> Project Name :- <?=$project_details_info?> || Buyer Name :- <?=$buyer_name?> </h4> 
