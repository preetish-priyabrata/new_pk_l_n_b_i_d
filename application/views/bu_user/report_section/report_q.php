...
<div class="sidebar-bg"></div>
       		...
       		<div class="panel panel-inverse">
										...
										foreach($query_supplyer_wise_info->result() as $row_project):
											...
											foreach ($query_array_design->result() as $key_design) {
												if($key_design->email_id==$design_user_id){
													...
													$data_buyer[] =$Username;
                                                    $data_buyer_detail[]= array('buyer_id' => $Username);
												}
                ...
                <div class="row">
                	...
                	<table class="table-bordered table">
                		...
                		<tr>
                			<th>PR released:</th>
                			<th><?=$total_no_release_pr?></th>
                		</tr>
						<tr>
							<th>PR not released:</th>
							<th><?=$total_no_pr_not_released?></th>
						</tr>
						<tr>
							<th>Technical cleared Items</th>
							<th><?=$total_planned_tech?></th>
						</tr>
						<tr>
							<th>Pending technical clearance</th>
							<th><?=$total_planned_not_tech?></th>
						</tr>
						<tr>
							<th>No of Items which got Manufacturing clearance</th>
							<th><?=$actual_mfg_no?></th>
						</tr>
						<tr>
							<th>No of Items waiting for Manufacturing clearance</th>
							<th><?=$actual_mfg_no_not?></th>
						</tr>
                	</table>
                </div>
                ...
                <?php
                 if(!empty($data_buyer)){
                            ...
                            foreach ($data_buyer_new as $key_buyer):
                                ...
                                $data_buyer_graph[] = array('buyer_name' =>$key_buyer, 'total_pr_no'=>$total_pr);
                            endforeach;
		...
		<script type="text/javascript">
		    ...
		    function drawChart() {
		      var data = google.visualization.arrayToDataTable([
				...
				['Total PR released',<?=$total_no_pr?>, "green"],
				['PR released',<?=$total_no_release_pr?>, "copper"],
				['PR not released',<?=$total_no_pr_not_released?>, "red"],
                ['Technical cleared items',<?=$total_planned_tech?>, "grey"],
				['Pending technical clearance',<?=$total_planned_not_tech?>, "yellow"],
				['No.of items which got Mfg. clearance',<?=$actual_mfg_no?>, "pink"],
		        ['No.of items waiting for Mfg. clearance',<?=$actual_mfg_no_not?>, "blue"],
		      ]);
		...
		<script type="text/javascript">
		    ...
		    function drawChart() {
		      var data = google.visualization.arrayToDataTable([
		        ["Buyer Name", "PR allocated no" ],
		         <?php
                    foreach ($data_buyer_graph as $key_info => $value_id) {
                        ?>
				['<?=$data_buyer_graph[$key_info]['buyer_name']?>',<?=$data_buyer_graph[$key_info]['total_pr_no']?>],
