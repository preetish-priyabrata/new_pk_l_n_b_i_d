...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Report C</li> 
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h3 class="page-header">List of POs which are delayed beyond schedule/List of PO to be released for given month<small></small></h3>
			<!-- end page-header -->
        ...
        <?php 
			...
			if($send_button=="find"){
				...
				$data_check = array('job_code' => $job_code,'MONTH(scheduled_order)'=>$job_code_month);               
                foreach ($query_design->result() as $key_job_code) {
			...
			<div class="panel panel-inverse">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <table id="table1bubu" class="table table-bordered" border="1">
                            <thead>
                                <tr>
                                    <th>Job Code</th>
                                    <th>PR Details</th>
