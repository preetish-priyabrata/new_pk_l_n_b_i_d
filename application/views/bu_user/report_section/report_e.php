...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">"Procurement & Projects"</li> 
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h3 class="page-header">"Procurement & Projects" <small></small></h3>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <table id="table1bu2" class="table table-bordered" border="1">
                            <thead>
                                <tr role="row">
                                	<th>Sl No.</th>
                                    <th>Area</th>
                                    ...
                                    <th>Ordered Value Basic Value in Rs.L</th>
                                   	<th>Cost Saving</th>                                    
									<th class="col-12 dt-body-right" style="width: 100%;">Bidder Information</th>
                            ...
                            <tbody>
								...
								$x=0;
									foreach($query_pr->result() as $row):
										...
										$number_bu=$query_check->num_rows();
										$query_vendor_information=$this->db->get_where('master_bid_Com_vendor_m',array('pr_no'=>$pr_no))->result();
										if($query_check->num_rows()==1){
											...
											if($commercial_complete==1){
												...
												$Bid_master_id_com=$result_process[0]->comm_bid;
                                                ...
                                                foreach ($query_vendor_detail->result() as $value) {
                                                    if($query_supplyer_wise[0]->Vendor_id==$value->Vendor_email_id){
														...
														$Organisation_name_ven_got=$value->Organisation_name;
														$Organisation_address_got=$value->Organisation_address;

                                                    }
                                                }
											}else{
												$Organisation_address_got=$Organisation_name_ven_got=$commercial_date='--';
											}
											...
											$buyer_user_name="--";
											$Organisation_address_got=$Organisation_name_ven_got=$release_buyer_date_comm="--";
											$total_no_received_offer="--";
                                ...
                                <tr>
									...
									<td><?=$Cost_saving_details?></td>
									 <td class="col-lg-2 dt-body-right" >
									 	<?php if($number_bu==1){
											...
											<?php 
											foreach($query_vendor_information as $vendor_info):
									...
									<td>
									organization :-<?=$Organisation_name_ven_got?>
								
													
									Address :- <?=$Organisation_address_got?>
									</td>
