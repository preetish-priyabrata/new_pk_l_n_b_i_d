...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h3 class="page-header">List of PRs Items which are Technically Cleared but Order is Pending<small></small></h3>
			<!-- end page-header -->
                            ...
                            <tbody>
                                <?php 
									foreach($query_pr->result() as $row):
										...
										$data_check=array('pr_no'=>$pr_no,'technical_complete_status'=>1 ,'commercial_complete_status'=>2);
