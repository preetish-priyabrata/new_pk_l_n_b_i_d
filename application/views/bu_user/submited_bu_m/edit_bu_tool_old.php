						         	...
						         	<div class="row">
										<div class="col-md-6 col-lg-6">
										 	<div class="form-group row m-b-15">
												<label class="col-form-label col-md-3" for="Date_creation"> BU Date of creation PR's<span style="color: red">*</span></label>
												<div class="col-md-9">
													<input class="form-control m-b-5 datepickers" placeholder="Enter BU Date of creation PR's" name="Date_creation" id="Date_creation" type="text" value="<?=$data_received->Date_creation?>" required="">
													<small class="f-s-12 text-grey-darker">Here enter BU Date of creation PR's</small>
												</div>
											</div>
											<div class="form-group row m-b-15">
											...
											<div class="form-group row m-b-15">
													...
													<div class="col-md-9">
														<input class="form-control m-b-5 datepickers" placeholder="Enter Delivery Date as per PO" name="delivery_date_as_per_po" id="delivery_date_as_per_po" value="<?=$new_field[0]->delivery_date_as_per_po?>" type="text"  required="" autocomplete="off">
											...
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control m-b-5 datepickers" placeholder="Enter Scheduled Delivery  Date" name="schedule_delivery_date" id="schedule_delivery_date" type="text" required=""   value="<?=$data_received->schedule_delivery_date?>"  >
													<small class="f-s-12 text-grey-darker">Here enter Scheduled Drawing Submission Date</small>
												</div>
											</div>
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control m-b-5 datepickers" placeholder="Enter Target Date of ordering" name="target_date_ordering" id="target_date_ordering" type="text" required=""  value="<?=$data_received->target_date_ordering?>" >
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group row m-b-15">
												<label class="col-form-label col-md-3" for="pr_item"> PR Details</label>
												<div class="col-md-9">
													<input class="form-control m-b-5" placeholder="Enter PR Description" name="pr_item" id="pr_item" type="text" value="<?=$item_name['item_name']?>" readonly>
													<small class="f-s-12 text-grey-darker">PR Details</small>
												</div>
											</div>
											<div class="form-group row m-b-15">
												<label class="col-form-label col-md-3" for="drg_submission_date">Drg submission date<span style="color: red">*</span></label>
												<div class="col-md-9">
													<input class="form-control m-b-5 datepickers" placeholder="Enter Drg submission date" name="drg_submission_date" id="drg_submission_date" type="text" required=""   value="<?=$new_field[0]->drg_submission_date?>"  >
