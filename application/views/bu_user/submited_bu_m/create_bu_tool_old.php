						         	...
						         	<div class="row">
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group row m-b-15">
													...
													<div class="col-md-9">
														<input class="form-control m-b-5 datepickers" placeholder="Enter Delivery Date as per PO" name="delivery_date_as_per_po" id="delivery_date_as_per_po" value="<?=$new_field[0]->delivery_date_as_per_po?>" type="text" disabled required="" autocomplete="off">
											...
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control m-b-5 datepickers" placeholder="Enter Scheduled Delivery  Date" name="schedule_delivery_date" id="schedule_delivery_date" type="text" required=""  disabled="" value="<?=$data_received->schedule_delivery_date?>"  >
													<small class="f-s-12 text-grey-darker">Here enter Scheduled Drawing Submission Date</small>
												</div>
											</div>
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control m-b-5 datepickers" placeholder="Enter Target Date of ordering" name="target_date_ordering" id="target_date_ordering" type="text" required="" disabled="" value="<?=$data_received->target_date_ordering?>" >
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control m-b-5" placeholder="Enter pr details" name="pr_item" id="pr_item" type="text" value="<?=$item_name['item_name']?>" readonly>
											...
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control m-b-5 datepickers" placeholder="Enter Drg submission date" name="drg_submission_date" id="drg_submission_date" type="text" required=""  disabled="" value="<?=$new_field[0]->drg_submission_date?>"  >
						        ...
						        <div class="card-body">
					        		...
					        		<div class="row">
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group row m-b-15">
													<label class="col-form-label col-md-3" for="Order_disabled value">Order Basic value in Rs L</label>
													<div class="col-md-9">
											...
											<div class="col-md-6 col-lg-6">
												<div class="form-group row m-b-15">
													<label class="col-form-label col-md-3" for="Invoice_disabled value">Invoice value Gross in RS l</label>
													<div class="col-md-9">
