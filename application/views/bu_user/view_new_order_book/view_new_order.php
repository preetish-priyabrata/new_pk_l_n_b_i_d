...
<div class="sidebar-bg"></div>
    ...
    <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active"> View New Order Book </li>
      </ol>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"> View New Order Book
      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">View New Order Book</h4>
        </div>
             ...
             <form action="" method="POST" enctype="multipart/form-data"  >              
                ...
                <div class="col-md-6 col-lg-6">
                  <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-3" for="project"> Project/Job Code <span style="color: red">*</span></label>
                    <div class="col-md-9">
