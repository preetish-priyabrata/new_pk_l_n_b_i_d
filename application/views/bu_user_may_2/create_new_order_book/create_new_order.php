            ...
            <div class="row">
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group row m-b-15">
                  ...
                  <div class="col-md-9">
                    <input class="form-control m-b-5 datepickers" autocomplete="off" placeholder="Enter LOI date" name="LOI_date_contract" id="LOI_date_contract" type="text" required="">
                  ...
                  <div class="col-md-9">
                    <input class="form-control m-b-5 datepickers" autocomplete="off" placeholder="Enter Contract start date" name="Contract_start_date" id="Contract_start_date" type="text" required="">
              ...
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group row m-b-15">
                  <label class="col-form-label col-md-3">Contract signing date  <span style="color: red">*</span></label>
                  <div class="col-md-9">
                    <input class="form-control m-b-5 datepickers" autocomplete="off" placeholder="Enter Contract signing date" name="Contract_sign_date" id="Contract_sign_date" type="text" required="">
                  ...
                  <div class="col-md-9">
                    <input class="form-control m-b-5 datepickers" autocomplete="off" placeholder="Enter Contratual completion" name="  Contract_completion_date" id="  Contract_completion_date" type="text" required="">
                ...
                <div class="form-group row m-b-15">
                  ...
                  <div class="col-md-9">
                    <input class="form-control m-b-5 datepickers" autocomplete="off" placeholder="Enter Target date of completion" name="Target_date_completion" id="Target_date_completion" type="text" required="">
                  ...
                  <div class="col-md-9">
                    <input class="form-control m-b-5 datepickers" autocomplete="off" placeholder="Enter Actual completion date" name=" Actual_completion_date" id="  Actual_completion_date" type="text" required="">
