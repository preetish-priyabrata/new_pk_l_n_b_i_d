...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">View Order Book</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">View Order Book  </h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Detail Information of Order Book </h4>
				</div>
				<div class="panel-body">
					<h3>Job code details of <?=$data_order->Job_code?><a href="<?=base_url()?>bu-edit-order-book/<?=$value1?>/<?=$value2?>" class="btn btn-primary btn-sm pull-right"> Edit Job Code Info </a></h3>
						    	<br>
						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5 datepickers" placeholder="Enter LOI date" name="LOI_date_contract" id="LOI_date_contract" type="text" required="" disabled="" value="<?=$data_order->LOI_date_contract?>">
                                ...
                                <div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5 " placeholder="Enter Contract value" name="Contract_value" id="Contract_value" type="text" required="" disabled="" value="<?=$data_order->Contract_value?>">
                                ...
                                <div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5 datepickers" placeholder="Enter Contract start date" name="Contract_start_date" id="Contract_start_date" type="text"  disabled="" value="<?=$data_order->Contract_start_date?>">
                                ...
                                <div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5 " placeholder="Enter Contract duration" name="Contract_duration" id="Contract_duration" type="text" disabled="" value="<?=$data_order->Contract_duration?>">
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<textarea class="form-control" rows="3" name="Remarks" required="" disabled=""><?=$data_order->Remark?></textarea>
							...
							<div class="col-md-6 col-lg-6">
							 	...
							 	<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<textarea class="form-control" rows="3" name="Project_desc" id="Project_desc" disabled=""><?=$data_order->Job_description?></textarea>
										<!-- <small class="f-s-12 text-grey-darker">  </small> -->
									</div>
								</div>
							 	...
							 	<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5 datepickers" placeholder="Enter Contract signing date" name="Contract_sign_date" id="Contract_sign_date" type="text" disabled value="<?=$data_order->Contract_sign_date?>">
                                ...
                                <div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5 " placeholder="Enter Supply order value" name="Supply_order_value" id="Supply_order_value" type="text" disabled value="<?=$data_order->Supply_order_value?>">
                                ...
                                <div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5 datepickers" placeholder="Enter Contratual completion" name="Contratual_completion" id="Contratual_completion" type="text" disabled value="<?=$data_order->Contractual_completion?>">
