						         	...
						         	<div class="row">
										<div class="col-md-6 col-lg-6">
										 	<div class="form-group row m-b-15">
												<label class="col-form-label col-md-3" for="Date_creation"> BU Date of create PR's<span style="color: red">*</span></label>
												<div class="col-md-9">
													...
													<small class="f-s-12 text-grey-darker">Here enter BU date of create PR's</small>
												</div>
											</div>
											<div class="form-group row m-b-15">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group row m-b-15">
												<label class="col-form-label col-md-3" for="pr_item"> PR Description </label>
												<div class="col-md-9">
													...
													<small class="f-s-12 text-grey-darker">PR Description</small>
												</div>
											</div>
