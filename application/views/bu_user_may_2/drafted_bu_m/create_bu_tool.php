...
$value=$value;
$resutl=$this->bumodal->get_bu_tracking_m(2,$value);
						         	...
						         	<div class="row">
										<div class="col-md-6 col-lg-6">
										 	<div class="form-group row m-b-15">
												<label class="col-form-label col-md-3" for="Date_creation"> Date of creation <span style="color: red">*</span></label>
												<div class="col-md-9">
											...
											<div class="col-md-6 col-lg-6">
												<div class="form-group row m-b-15">
													...
													<div class="col-md-9">
														...
														<small class="f-s-12 text-grey-darker">Here enter Qnty Received At Site </small>
													</div>
												</div>
												<div class="form-group row m-b-15">
