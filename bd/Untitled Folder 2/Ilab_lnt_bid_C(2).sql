...
--
-- Host: localhost:3306
-- Generation Time: Mar 30, 2019 at 07:11 PM
...
(1, 1, '2019-03-24', '2019-03-30', '2019-03-27', 1, 1, 'Any dispute relating in any way to your visit to the AWS Site or to services provided by AWS or through the AWS Site in which the aggregate total claim for relief sought on behalf of one or more parties exceeds $7,500 shall be adjudicated in any state or federal court in King County, Washington, and you consent to exclusive jurisdiction and venue in such courts.', 'O18191-950-E-K-30101-001', 2, 0),
(4, 16, '2019-04-27', '2019-04-26', '2019-04-23', 1, 4, 'D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrat', 'O900-102-A-C-40101-003', 1, 0),
(5, 15, '2019-04-12', '2019-04-19', '2019-04-13', 1, 5, 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.', 'O900-101-A-C-40101-002', 1, 0);
...
(4, 16, 'tsf', 'A Database Error Occurred\r\nError Number: 1054\r\n\r\nUnknown column \'status\' in \'field list\'\r\n\r\nUPDATE `Ilab_master_bid_Com_details_m` SET `status` = 1 WHERE `pr_slno` = \'16\' AND `pr_no` = \'O900-102-A-C-40101-003\' AND `edit_id_bid` = D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrat', '4400', 'rkl', 4, 'O900-102-A-C-40101-003', 1, 0),
(5, 15, 'ttf', 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.', '8900', 'rkl', 5, 'O900-101-A-C-40101-002', 1, 0);
...
(1, 1, 'O18191-950-E-K-30101-001', '21', 1, 1, 0, 2, 0),
(4, 16, 'O900-102-A-C-40101-003', '21', 4, 1, 0, 1, 0),
(5, 15, 'O900-101-A-C-40101-002', '21', 5, 1, 0, 1, 0);
...
(1, 1, '2019-03-28', 'REF 2018', 'bid 0012', NULL, 'Closed Bid', '2', 1, 'O18191-950-E-K-30101-001', '1', 2, 'Test bid summary', 'Please review our other policies on the AWS Site. These policies also govern your visit to the AWS Site. We reserve the right to make changes to the AWS Site, policies, and these Site Terms at any time. If any of these conditions shall be deemed invalid, void, or for any reason unenforceable, that condition shall be deemed severable and shall not affect the validity and enforceability of any remaining condition.', '2019-03-28 12:53:21', 'buy1@ilab.com', '2019-03-24', '2019-03-30', 0, '100000'),
(4, 16, '2019-03-30', '66400', '7701', NULL, 'Simple Bid', '2', 1, 'O900-102-A-C-40101-003', '1', 1, 'tsf', 'A Database Error Occurred\r\nError Number: 1054\r\n\r\nUnknown column \'status\' in \'field list\'\r\n\r\nUPDATE `Ilab_master_bid_Com_details_m` SET `status` = 1 WHERE `pr_slno` = \'16\' AND `pr_no` = \'O900-102-A-C-40101-003\' AND `edit_id_bid` = D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrat', '2019-03-30 07:07:59', 'buy1@ilab.com', '2019-04-24', '2019-04-19', 0, '333'),
(5, 15, '2019-03-30', '550', '3022', NULL, 'Closed Bid', '2', 1, 'O900-101-A-C-40101-002', '1', 1, 'ttf', 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.', '2019-03-30 07:10:14', 'buy1@ilab.com', '2019-04-27', '2019-04-11', 0, '400');
...
(1, 2, 'vender2@ilab.com', 1, 1, NULL, '0', '0', 'Test bid summary', 'Please review our other policies on the AWS Site. These policies also govern your visit to the AWS Site. We reserve the right to make changes to the AWS Site, policies, and these Site Terms at any time. If any of these conditions shall be deemed invalid, ', '2019-03-24', '2019-03-30', '2019-03-27', 1, 0, 'REF 2018', 'bid 0012', '', 'Closed Bid', '2', 1, 'O18191-950-E-K-30101-001', '1', 3, '', '2019-03-28 12:53:21', '2019-03-30 07:07:00', 1, 5, NULL, 0),
(2, 2, 'vender@ilab.com', 2, 1, NULL, '0', '0', 'Test bid summary', 'Please review our other policies on the AWS Site. These policies also govern your visit to the AWS Site. We reserve the right to make changes to the AWS Site, policies, and these Site Terms at any time. If any of these conditions shall be deemed invalid, ', '2019-03-24', '2019-03-30', '2019-03-27', 1, 0, 'REF 2018', 'bid 0012', '', 'Closed Bid', '2', 1, 'O18191-950-E-K-30101-001', '1', 3, '', '2019-03-28 12:53:21', '2019-03-30 07:07:00', 1, 5, NULL, 0),
(3, 2, 'ven121@gmail.com', 4, 1, NULL, '0', '0', 'Test bid summary', 'Please review our other policies on the AWS Site. These policies also govern your visit to the AWS Site. We reserve the right to make changes to the AWS Site, policies, and these Site Terms at any time. If any of these conditions shall be deemed invalid, ', '2019-03-24', '2019-03-30', '2019-03-27', 1, 0, 'REF 2018', 'bid 0012', '', 'Closed Bid', '2', 1, 'O18191-950-E-K-30101-001', '1', 3, '', '2019-03-28 12:53:21', '2019-03-30 12:05:29', 1, 6, NULL, 0),
(4, 2, 'ven310@yahoo.com', 7, 1, NULL, '0', '0', 'Test bid summary', 'Please review our other policies on the AWS Site. These policies also govern your visit to the AWS Site. We reserve the right to make changes to the AWS Site, policies, and these Site Terms at any time. If any of these conditions shall be deemed invalid, ', '2019-03-24', '2019-03-30', '2019-03-27', 1, 0, 'REF 2018', 'bid 0012', '', 'Closed Bid', '2', 1, 'O18191-950-E-K-30101-001', '1', 3, '', '2019-03-28 12:53:21', '2019-03-30 07:07:00', 1, 5, NULL, 0),
(14, 1, 'vender2@ilab.com', 1, 1, NULL, '0', '0', 'tsf', 'A Database Error Occurred\r\nError Number: 1054\r\n\r\nUnknown column \'status\' in \'field list\'\r\n\r\nUPDATE `Ilab_master_bid_Com_details_m` SET `status` = 1 WHERE `pr_slno` = \'16\' AND `pr_no` = \'O900-102-A-C-40101-003\' AND `edit_id_bid` = D materials are crystalli', '2019-04-27', '2019-04-26', '2019-04-23', 4, 0, '66400', '7701', '', 'Simple Bid', '2', 16, 'O900-102-A-C-40101-003', '1', 1, '', '2019-03-30 07:08:00', '2019-03-30 07:08:00', 1, 5, NULL, 0),
(15, 1, 'vender@ilab.com', 2, 1, NULL, '0', '0', 'tsf', 'A Database Error Occurred\r\nError Number: 1054\r\n\r\nUnknown column \'status\' in \'field list\'\r\n\r\nUPDATE `Ilab_master_bid_Com_details_m` SET `status` = 1 WHERE `pr_slno` = \'16\' AND `pr_no` = \'O900-102-A-C-40101-003\' AND `edit_id_bid` = D materials are crystalli', '2019-04-27', '2019-04-26', '2019-04-23', 4, 0, '66400', '7701', '', 'Simple Bid', '2', 16, 'O900-102-A-C-40101-003', '1', 1, '', '2019-03-30 07:08:00', '2019-03-30 07:08:00', 1, 5, NULL, 0),
(16, 1, 'ven121@gmail.com', 4, 1, NULL, '0', '0', 'tsf', 'A Database Error Occurred\r\nError Number: 1054\r\n\r\nUnknown column \'status\' in \'field list\'\r\n\r\nUPDATE `Ilab_master_bid_Com_details_m` SET `status` = 1 WHERE `pr_slno` = \'16\' AND `pr_no` = \'O900-102-A-C-40101-003\' AND `edit_id_bid` = D materials are crystalli', '2019-04-27', '2019-04-26', '2019-04-23', 4, 0, '66400', '7701', '', 'Simple Bid', '2', 16, 'O900-102-A-C-40101-003', '1', 1, '', '2019-03-30 07:08:00', '2019-03-30 12:50:12', 1, 6, NULL, 0),
(17, 1, 'ven310@yahoo.com', 7, 1, NULL, '0', '0', 'tsf', 'A Database Error Occurred\r\nError Number: 1054\r\n\r\nUnknown column \'status\' in \'field list\'\r\n\r\nUPDATE `Ilab_master_bid_Com_details_m` SET `status` = 1 WHERE `pr_slno` = \'16\' AND `pr_no` = \'O900-102-A-C-40101-003\' AND `edit_id_bid` = D materials are crystalli', '2019-04-27', '2019-04-26', '2019-04-23', 4, 0, '66400', '7701', '', 'Simple Bid', '2', 16, 'O900-102-A-C-40101-003', '1', 1, '', '2019-03-30 07:08:00', '2019-03-30 07:08:00', 1, 5, NULL, 0),
(18, 1, 'vender2@ilab.com', 1, 1, NULL, '0', '0', 'ttf', 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical ', '2019-04-12', '2019-04-19', '2019-04-13', 5, 0, '550', '3022', '', 'Closed Bid', '2', 15, 'O900-101-A-C-40101-002', '1', 1, '', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 1, 5, NULL, 0),
(19, 1, 'vender@ilab.com', 2, 1, NULL, '0', '0', 'ttf', 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical ', '2019-04-12', '2019-04-19', '2019-04-13', 5, 0, '550', '3022', '', 'Closed Bid', '2', 15, 'O900-101-A-C-40101-002', '1', 1, '', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 1, 5, NULL, 0),
(20, 1, 'ven121@gmail.com', 4, 1, NULL, '0', '0', 'ttf', 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical ', '2019-04-12', '2019-04-19', '2019-04-13', 5, 0, '550', '3022', '', 'Closed Bid', '2', 15, 'O900-101-A-C-40101-002', '1', 1, '', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 1, 5, NULL, 0),
(21, 1, 'ven310@yahoo.com', 7, 1, NULL, '0', '0', 'ttf', 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical ', '2019-04-12', '2019-04-19', '2019-04-13', 5, 0, '550', '3022', '', 'Closed Bid', '2', 15, 'O900-101-A-C-40101-002', '1', 1, '', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 1, 5, NULL, 0);
...
(2, 13, '2019-04-16', '2019-04-26', '2019-04-24', 1, 2, 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', 'O18191-950-E-K-30113-001', 1),
(3, 12, '2019-04-24', '2019-04-25', '2019-04-30', 1, 3, 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', 'O18191-950-E-K-30112-001', 1),
(4, 11, '2019-03-13', '2018-12-27', '2019-03-20', 1, 4, 'For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'O18191-950-E-K-30111-001', 1);
...
(2, 13, 'ttyi', 'silica (SiO2) in vitreous, or glass, form (i.e., its molecules are disordered and random, without crystalline structure). It has very low thermal expansion, is very hard, and resists high temperatures (1000–1500 °C). It is also the most resistant against weathering (caused in other glasses by alkali ions leaching out of the glass, while staining it). Fused quartz is used for high-temperature applications such as furnace tubes, lighting tubes, melting crucibles, etc.', '3400hrs', 'ctc', 2, 'O18191-950-E-K-30113-001', 1),
(3, 12, 'iiuiui', 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', '6780hrs', 'rkl', 3, 'O18191-950-E-K-30112-001', 1),
(4, 11, 'tgh', 'For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', '7700', 'rkl', 4, 'O18191-950-E-K-30111-001', 1);
...
(2, 13, '2019-03-29', '1221200', '9909123', NULL, 'Simple Bid', '1', 1, 'O18191-950-E-K-30113-001', '1', 1, 'ttyi', 'silica (SiO2) in vitreous, or glass, form (i.e., its molecules are disordered and random, without crystalline structure). It has very low thermal expansion, is very hard, and resists high temperatures (1000–1500 °C). It is also the most resistant against weathering (caused in other glasses by alkali ions leaching out of the glass, while staining it). Fused quartz is used for high-temperature applications such as furnace tubes, lighting tubes, melting crucibles, etc.', '2019-03-29 09:43:57', 'buy1@ilab.com', '2019-03-30', '2019-03-31'),
(3, 12, '2019-03-29', '770089', '9956009', NULL, 'Closed Bid', '1', 1, 'O18191-950-E-K-30112-001', '1', 1, 'iiuiui', 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', '2019-03-29 09:58:30', 'buy1@ilab.com', '2019-03-31', '2019-03-31'),
(4, 11, '2019-03-30', '68009', '7779', NULL, 'Simple Bid', '1', 1, 'O18191-950-E-K-30111-001', '1', 1, 'tgh', 'For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', '2019-03-30 13:28:23', 'buy1@ilab.com', '2019-03-22', '2019-03-29');
...
(2, 13, 'O18191-950-E-K-30113-001', '19', 2, 1, 0, 1),
(3, 12, 'O18191-950-E-K-30112-001', '19', 3, 1, 0, 1),
(4, 11, 'O18191-950-E-K-30111-001', '19', 4, 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `Ilab_master_bid_t_c_comm_m`
--

CREATE TABLE `Ilab_master_bid_t_c_comm_m` (
  `slno` int(11) NOT NULL,
  `pr_no` varchar(255) NOT NULL,
  `pr_slno` int(11) NOT NULL,
  `edit_id_bid` int(11) NOT NULL DEFAULT '0',
...
(2, 'O900-102-A-C-40101-003', 16, 1, '<p>Box-shaped graphene (BSG) nanostructure is an example of 3D nanomaterial.[36] BSG nanostructure has appeared after mechanical cleavage of pyrolytic graphite. This nanostructure is a multilayer system of parallel hollow nanochannels located along the surface and having quadrangular cross-section. The thickness of the channel walls is approximately equal to 1 nm. The typical width of channel facets makes about 25 nm.</p>\r\n\r\n<p>2D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrate.</p>\r\n', '2019-03-30 06:52:54', 0),
(3, 'O900-102-A-C-40101-003', 16, 1, '<p>2D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrate.</p>\r\n', '2019-03-30 06:55:38', 0),
(4, 'O900-102-A-C-40101-003', 16, 1, '<p>D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrat</p>\r\n\r\n<p>The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.</p>\r\n', '2019-03-30 07:08:00', 0),
(5, 'O900-101-A-C-40101-002', 15, 1, '<p>The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.</p>\r\n\r\n<p>The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.</p>\r\n', '2019-03-30 07:10:15', 0);

-- --------------------------------------------------------

--
-- Table structure for table `Ilab_master_bid_t_c_tech_m`
--

CREATE TABLE `Ilab_master_bid_t_c_tech_m` (
  `slno` int(11) NOT NULL,
  `pr_no` varchar(255) NOT NULL,
  `pr_slno` int(11) NOT NULL,
  `edit_id_bid` int(11) NOT NULL DEFAULT '0',
...
(2, 'O18191-950-E-K-30113-001', 13, 1, '<p>resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.</p>\r\n', '2019-03-29 09:43:57'),
(3, 'O18191-950-E-K-30112-001', 12, 1, '<p>resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.</p>\r\n\r\n<p>resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.</p>\r\n', '2019-03-29 09:58:30'),
(4, 'O18191-950-E-K-30111-001', 11, 1, '<p>For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580&nbsp;mm)</p>\r\n\r\n<p>For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580&nbsp;mm)</p>\r\n', '2019-03-30 13:28:23');
...
(3, 30, 30, 'ven121@gmail.com', 1, NULL, '0', '0', 'tthh', 'kkllg', '2019-05-07', '2019-06-20', '2019-05-10', 1, 0, '5500', '7790', '1', 'Simple Bid', '1', 30, '2019-02-01-kJV97', '0770', 1, 'standard catalogued item [ SCI ]', '2019-02-20 12:22:26', '2019-03-29 09:13:53', 1, 6, NULL),
...
CREATE TABLE `Ilab_master_bid_vendor_m` (
  ...
  `vendor_id` varchar(255) NOT NULL,
  `slno_vendor_id_master` int(11) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '1->i bid is active to now 4>bid is not not active by buer  5->bid is scrap out by buyer 6->?bid is closed buyer which mean bid is solution with buyer 7 bid is cloed automatic',
  `approval_status` varchar(255) DEFAULT NULL,
  `submission_status` varchar(255) DEFAULT '0',
  `submission_count` varchar(255) NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
(3, 1, 'ven121@gmail.com', 4, 1, NULL, '1', '0', 'Test bid summary', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has su', '2019-03-25', '2019-03-30', '2019-03-28', 1, 0, 'bid 1', 'bid 001', '', 'Simple Bid', '1', 8, 'O18191-950-E-K-30108-001', '1', 1, '', '2019-03-27 07:17:17', '2019-03-30 06:31:03', 1, 7, NULL),
...
(8, 1, 'ven121@gmail.com', 4, 1, NULL, '0', '0', 'ttyi', 'silica (SiO2) in vitreous, or glass, form (i.e., its molecules are disordered and random, without crystalline structure). It has very low thermal expansion, is very hard, and resists high temperatures (1000–1500 °C). It is also the most resistant against ', '2019-04-16', '2019-04-26', '2019-04-24', 2, 0, '1221200', '9909123', '', 'Simple Bid', '1', 13, 'O18191-950-E-K-30113-001', '1', 1, '', '2019-03-29 09:43:57', '2019-03-30 07:23:54', 1, 6, NULL),
(9, 1, 'ven1011@yahoo.com', 8, 1, NULL, '0', '0', 'ttyi', 'silica (SiO2) in vitreous, or glass, form (i.e., its molecules are disordered and random, without crystalline structure). It has very low thermal expansion, is very hard, and resists high temperatures (1000–1500 °C). It is also the most resistant against ', '2019-04-16', '2019-04-26', '2019-04-24', 2, 0, '1221200', '9909123', '', 'Simple Bid', '1', 13, 'O18191-950-E-K-30113-001', '1', 1, '', '2019-03-29 09:43:57', '2019-03-29 09:43:58', 1, 5, NULL),
(10, 1, 'ven90@gmail.com', 12, 1, NULL, '0', '0', 'ttyi', 'silica (SiO2) in vitreous, or glass, form (i.e., its molecules are disordered and random, without crystalline structure). It has very low thermal expansion, is very hard, and resists high temperatures (1000–1500 °C). It is also the most resistant against ', '2019-04-16', '2019-04-26', '2019-04-24', 2, 0, '1221200', '9909123', '', 'Simple Bid', '1', 13, 'O18191-950-E-K-30113-001', '1', 1, '', '2019-03-29 09:43:57', '2019-03-29 09:43:58', 1, 5, NULL),
(11, 1, 'vender2@ilab.com', 1, 1, NULL, '0', '0', 'iiuiui', 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', '2019-04-24', '2019-04-25', '2019-04-30', 3, 0, '770089', '9956009', '', 'Closed Bid', '1', 12, 'O18191-950-E-K-30112-001', '1', 1, '', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 1, 5, NULL),
(12, 1, 'vender@ilab.com', 2, 1, NULL, '0', '0', 'iiuiui', 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', '2019-04-24', '2019-04-25', '2019-04-30', 3, 0, '770089', '9956009', '', 'Closed Bid', '1', 12, 'O18191-950-E-K-30112-001', '1', 1, '', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 1, 5, NULL),
(13, 1, 'ven121@gmail.com', 4, 1, NULL, '0', '0', 'iiuiui', 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', '2019-04-24', '2019-04-25', '2019-04-30', 3, 0, '770089', '9956009', '', 'Closed Bid', '1', 12, 'O18191-950-E-K-30112-001', '1', 1, '', '2019-03-29 09:58:30', '2019-03-30 07:32:03', 1, 6, NULL),
(14, 1, 'ven310@yahoo.com', 7, 1, NULL, '0', '0', 'iiuiui', 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', '2019-04-24', '2019-04-25', '2019-04-30', 3, 0, '770089', '9956009', '', 'Closed Bid', '1', 12, 'O18191-950-E-K-30112-001', '1', 1, '', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 1, 5, NULL),
(15, 1, 'ven1011@yahoo.com', 8, 1, NULL, '0', '0', 'iiuiui', 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', '2019-04-24', '2019-04-25', '2019-04-30', 3, 0, '770089', '9956009', '', 'Closed Bid', '1', 12, 'O18191-950-E-K-30112-001', '1', 1, '', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 1, 5, NULL),
(16, 1, 'ven121@gmail.com', 4, 1, NULL, '0', '0', 'tgh', 'For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', '2019-03-13', '2018-12-27', '2019-03-20', 4, 0, '68009', '7779', '', 'Simple Bid', '1', 11, 'O18191-950-E-K-30111-001', '1', 1, '', '2019-03-30 13:28:23', '2019-03-30 13:28:23', 1, 5, NULL),
(17, 1, 'vender@ilab.com', 2, 1, NULL, '0', '0', 'tgh', 'For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', '2019-03-13', '2018-12-27', '2019-03-20', 4, 0, '68009', '7779', '', 'Simple Bid', '1', 11, 'O18191-950-E-K-30111-001', '1', 1, '', '2019-03-30 13:28:23', '2019-03-30 13:28:23', 1, 5, NULL),
(18, 1, 'vender2@ilab.com', 1, 1, NULL, '0', '0', 'tgh', 'For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', '2019-03-13', '2018-12-27', '2019-03-20', 4, 0, '68009', '7779', '', 'Simple Bid', '1', 11, 'O18191-950-E-K-30111-001', '1', 1, '', '2019-03-30 13:28:23', '2019-03-30 13:28:23', 1, 5, NULL);
...
(16, 'O18191-950-E-K-30112-001', 12, 1, 'electrical', 1, '2019-03-29-undraw_resume_1hqp.svg', 'undraw_resume_1hqp.svg', '2019-03-29 09:33:09', 'design2@ilab.com'),
(17, 'O18191-950-E-K-30113-001', 13, 1, 'glass', 1, '2019-03-29-undraw_teaching_f1cm (1).svg', 'undraw_teaching_f1cm (1).svg', '2019-03-29 09:36:44', 'design2@ilab.com'),
(18, 'O18191-950-E-K-30105-001', 5, 1, 'wood', 2, '2019-03-29-undraw_resume_1hqp.svg', 'undraw_resume_1hqp.svg', '2019-03-29 09:52:36', 'design2@ilab.com'),
(19, 'O900-100-A-C-40101-001', 14, 1, 'electrical', 1, '2019-03-30-undraw_windows_q9m0.svg', 'undraw_windows_q9m0.svg', '2019-03-30 06:43:37', 'design2@ilab.com'),
(20, 'O900-101-A-C-40101-002', 15, 1, 'glass', 1, '2019-03-30-undraw_team_ih79.svg', 'undraw_team_ih79.svg', '2019-03-30 06:44:26', 'design2@ilab.com'),
(21, 'O900-102-A-C-40101-003', 16, 1, 'nanomaterials', 1, '2019-03-30-undraw_mail_cg1t.svg', 'undraw_mail_cg1t.svg', '2019-03-30 06:45:16', 'design2@ilab.com'),
(22, 'O900-103-A-C-40101-004', 17, 1, 'electrical', 1, '2019-03-30-undraw_statistics_ctoq.svg', 'undraw_statistics_ctoq.svg', '2019-03-30 13:22:27', 'design2@ilab.com');
...
(5, 'O18191-950-E-K-30105-001', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'wood', 1, 1, 1, 3, 2, '2019-03-29', '15:22:47', '2019-03-30 06:47:17', '2019-03-29', '15:22:47', '2019-03-27', 'design2@ilab.com', 1, '2019-03-30'),
...
(10, 'O18191-950-E-K-30110-001', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 1, 4, 0, 0, 1, '2019-03-28', '12:12:10', '2019-03-29 09:53:46', NULL, NULL, '2019-04-17', 'design2@ilab.com', 1, '2019-03-29'),
...
(12, 'O18191-950-E-K-30112-001', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 1, 4, 0, 0, 1, '2019-03-29', '15:03:38', '2019-03-29 09:38:00', NULL, NULL, '2019-04-11', 'design2@ilab.com', 1, '2019-03-29'),
(13, 'O18191-950-E-K-30113-001', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'glass', 1, 4, 0, 0, 1, '2019-03-29', '15:06:54', '2019-03-29 09:38:32', NULL, NULL, '2019-04-11', 'design2@ilab.com', 1, '2019-03-29'),
(14, 'O900-100-A-C-40101-001', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 2, 4, 0, 0, 1, '2019-03-30', '12:13:47', '2019-03-30 06:43:47', NULL, NULL, '2019-04-23', 'design2@ilab.com', 0, NULL),
(15, 'O900-101-A-C-40101-002', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'computer', 2, 4, 0, 0, 1, '2019-03-30', '12:14:34', '2019-03-30 06:46:56', NULL, NULL, '2019-04-06', 'design2@ilab.com', 1, '2019-03-30'),
(16, 'O900-102-A-C-40101-003', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'nanomaterials', 2, 4, 0, 0, 1, '2019-03-30', '12:15:42', '2019-03-30 06:46:32', NULL, NULL, '2019-05-27', 'design2@ilab.com', 1, '2019-03-30'),
(17, 'O900-103-A-C-40101-004', 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 1, 4, 0, 0, 1, '2019-03-30', '18:52:44', '2019-03-30 13:23:39', NULL, NULL, '2019-03-04', 'design2@ilab.com', 1, '2019-03-30');
...
(6, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'wood', 2, 4, 0, 0, 1, '2019-03-18', '11:27:12', '2019-03-30 06:47:17', NULL, NULL, '2019-03-27', 'design2@ilab.com', 1, '2019-03-30', 5, 'O18191-950-E-K-30105-001'),
...
(13, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 1, 4, 0, 0, 1, '2019-03-28', '12:12:10', '2019-03-29 09:53:46', NULL, NULL, '2019-04-17', 'design2@ilab.com', 1, '2019-03-29', 10, 'O18191-950-E-K-30110-001'),
...
(15, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 1, 4, 0, 0, 1, '2019-03-29', '15:03:38', '2019-03-29 09:38:00', NULL, NULL, '2019-04-11', 'design2@ilab.com', 1, '2019-03-29', 12, 'O18191-950-E-K-30112-001'),
(16, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'glass', 1, 4, 0, 0, 1, '2019-03-29', '15:06:54', '2019-03-29 09:38:32', NULL, NULL, '2019-04-11', 'design2@ilab.com', 1, '2019-03-29', 13, 'O18191-950-E-K-30113-001'),
(17, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'wood', 1, 4, 0, 0, 2, '2019-03-29', '15:22:47', '2019-03-30 06:47:17', NULL, NULL, '2019-03-27', 'design2@ilab.com', 1, '2019-03-30', 5, 'O18191-950-E-K-30105-001'),
(18, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 2, 4, 0, 0, 1, '2019-03-30', '12:13:47', '2019-03-30 06:43:47', NULL, NULL, '2019-04-23', 'design2@ilab.com', 0, NULL, 14, 'O900-100-A-C-40101-001'),
(19, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'computer', 2, 4, 0, 0, 1, '2019-03-30', '12:14:34', '2019-03-30 06:46:56', NULL, NULL, '2019-04-06', 'design2@ilab.com', 1, '2019-03-30', 15, 'O900-101-A-C-40101-002'),
(20, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'nanomaterials', 2, 4, 0, 0, 1, '2019-03-30', '12:15:42', '2019-03-30 06:46:32', NULL, NULL, '2019-05-27', 'design2@ilab.com', 1, '2019-03-30', 16, 'O900-102-A-C-40101-003'),
(21, 18, 'siprah@gmail.com', 'Approver5', 1, '0770', 'electrical', 1, 4, 0, 0, 1, '2019-03-30', '18:52:44', '2019-03-30 13:23:39', NULL, NULL, '2019-03-04', 'design2@ilab.com', 1, '2019-03-30', 17, 'O900-103-A-C-40101-004');
...
(3, 'O900-102-A-C-40101-003', 16, 12, 'bulknanostructured material', '0', 'No', '4421', 1, 'Box-shaped graphene (BSG) nanostructure is an example of 3D nanomaterial.[36] BSG nanostructure has appeared after mechanical cleavage of pyrolytic graphite. This nanostructure is a multilayer system of parallel hollow nanochannels located along the surface and having quadrangular cross-section. The thickness of the channel walls is approximately equal to 1 nm. The typical width of channel facets makes about 25 nm.', 'nanomaterials', 100.0000000000000000000, 0.0000000000000000000, '2019-03-30 06:52:53', '2019-03-30 06:52:53', 0, 'buy1@ilab.com', 1, 55, 2),
(4, 'O900-102-A-C-40101-003', 55, 11, '2-D nano', '1', 'set', '4420', 1, '2D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrate.', 'nanomaterials', 150.0000000000000000000, 150.0000000000000000000, '2019-03-30 06:52:53', '2019-03-30 06:52:53', 0, 'buy1@ilab.com', 1, 56, 2),
(5, 'O900-102-A-C-40101-003', 56, 10, '1-D nano', '10', '--', '4419', 1, 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.\n\n', 'nanomaterials', 220.0000000000000000000, 2200.0000000000000000000, '2019-03-30 06:52:53', '2019-03-30 06:52:53', 0, 'buy1@ilab.com', 1, 57, 2),
(6, 'O900-102-A-C-40101-003', 16, 12, 'bulknanostructured material', '0', 'No', '4421', 1, 'Box-shaped graphene (BSG) nanostructure is an example of 3D nanomaterial.[36] BSG nanostructure has appeared after mechanical cleavage of pyrolytic graphite. This nanostructure is a multilayer system of parallel hollow nanochannels located along the surface and having quadrangular cross-section. The thickness of the channel walls is approximately equal to 1 nm. The typical width of channel facets makes about 25 nm.', 'nanomaterials', 22.0000000000000000000, 0.0000000000000000000, '2019-03-30 06:55:37', '2019-03-30 06:55:37', 0, 'buy1@ilab.com', 1, 55, 3),
(7, 'O900-102-A-C-40101-003', 55, 11, '2-D nano', '1', 'set', '4420', 1, '2D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrate.', 'nanomaterials', 30.0000000000000000000, 30.0000000000000000000, '2019-03-30 06:55:37', '2019-03-30 06:55:37', 0, 'buy1@ilab.com', 1, 56, 3),
(8, 'O900-102-A-C-40101-003', 56, 10, '1-D nano', '10', '--', '4419', 1, 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.\n\n', 'nanomaterials', 50.0000000000000000000, 500.0000000000000000000, '2019-03-30 06:55:37', '2019-03-30 06:55:37', 0, 'buy1@ilab.com', 1, 57, 3),
(9, 'O900-102-A-C-40101-003', 16, 12, 'bulknanostructured material', '0', 'No', '4421', 1, 'Box-shaped graphene (BSG) nanostructure is an example of 3D nanomaterial.[36] BSG nanostructure has appeared after mechanical cleavage of pyrolytic graphite. This nanostructure is a multilayer system of parallel hollow nanochannels located along the surface and having quadrangular cross-section. The thickness of the channel walls is approximately equal to 1 nm. The typical width of channel facets makes about 25 nm.', 'nanomaterials', 11.0000000000000000000, 0.0000000000000000000, '2019-03-30 07:07:59', '2019-03-30 07:07:59', 0, 'buy1@ilab.com', 1, 55, 4),
(10, 'O900-102-A-C-40101-003', 55, 11, '2-D nano', '1', 'set', '4420', 1, '2D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrate.', 'nanomaterials', 21.0000000000000000000, 21.0000000000000000000, '2019-03-30 07:07:59', '2019-03-30 07:07:59', 0, 'buy1@ilab.com', 1, 56, 4),
(11, 'O900-102-A-C-40101-003', 56, 10, '1-D nano', '10', '--', '4419', 1, 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.\n\n', 'nanomaterials', 13.0000000000000000000, 130.0000000000000000000, '2019-03-30 07:07:59', '2019-03-30 07:07:59', 0, 'buy1@ilab.com', 1, 57, 4),
(12, 'O900-101-A-C-40101-002', 15, 6, 'computer', '1', 'No', '4415', 1, 'DDR3 ram 4GB,HDD,Core duo-processor ', 'computer', 10.0000000000000000000, 10.0000000000000000000, '2019-03-30 07:10:14', '2019-03-30 07:10:14', 0, 'buy1@ilab.com', 1, 54, 5);
...
(41, 'O18191-950-E-K-30112-001', 12, 1, 'electric bulb 100watt', '1', 'SET', '4410', 1, '2019-03-29 09:33:38', NULL, NULL, NULL, 'To improve the efficiency of the lamp, the filament usually consists of multiple coils of coiled fine wire, also known as a \'coiled coil\'. Light bulbs using coiled coil filaments are sometimes referred to as \'double-coil bulbs\'. For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'electrical'),
(42, 'O18191-950-E-K-30112-001', 41, 2, 'candle flame bulb 60 watt', '1', 'No', '4411', 1, '2019-03-29 09:33:38', NULL, NULL, NULL, '?35 mm (~?11/8\") candle-flame shape, ?12 mm Edison screw', 'electrical'),
(43, 'O18191-950-E-K-30112-001', 42, 15, 'electric bulb 60 watt', '1', '1', '4424', 1, '2019-03-29 09:33:38', NULL, NULL, NULL, ' For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'electrical'),
(44, 'O18191-950-E-K-30113-001', 13, 3, 'fused silica glass', '1', 'Set', '4412', 1, '2019-03-29 09:36:54', NULL, NULL, NULL, ' silica (SiO2) in vitreous, or glass, form (i.e., its molecules are disordered and random, without crystalline structure). It has very low thermal expansion, is very hard, and resists high temperatures (1000–1500 °C). It is also the most resistant against weathering (caused in other glasses by alkali ions leaching out of the glass, while staining it). Fused quartz is used for high-temperature applications such as furnace tubes, lighting tubes, melting crucibles, etc.', 'glass'),
(45, 'O18191-950-E-K-30113-001', 44, 4, 'fiber glass', '1', 'Set', '4413', 1, '2019-03-29 09:36:54', NULL, NULL, NULL, 'Fiberglass filaments are made through a pultrusion process in which the raw materials (sand, limestone, kaolin clay, fluorspar, colemanite, dolomite and other minerals) are melted in a large furnace into a liquid which is extruded through very small orifices (5–25 micrometres in diameter if the glass is E-glass and 9 micrometers if the glass is S-glass).', 'glass'),
(46, 'O18191-950-E-K-30113-001', 45, 5, 'fused silica glass', '1', 'Na', '4414', 1, '2019-03-29 09:36:54', NULL, NULL, NULL, ' silica (SiO2) in vitreous, or glass, form (i.e., its molecules are disordered and random, without crystalline structure). It has very low thermal expansion, is very hard, and resists high temperatures (1000–1500 °C). It is also the most resistant against weathering (caused in other glasses by alkali ions leaching out of the glass, while staining it). Fused quartz is used for high-temperature applications such as furnace tubes, lighting tubes, melting crucibles, etc.', 'Glass'),
(47, 'O18191-950-E-K-30113-001', 46, 17, 'network glass', '1', 'NO', '4426', 1, '2019-03-29 09:36:54', NULL, NULL, NULL, 'resulting glass contains about 70 to 74% silica by weight and is called a soda-lime glass.[4] Soda-lime glasses account for about 90% of manufactured glass.', 'glass'),
(48, 'O18191-950-E-K-30105-001', 5, 20, 'monocot wood', '1', 'set', '4429', 2, '2019-03-29 09:52:47', NULL, NULL, NULL, 'is fairly constant from 14 to 38 rings per inch (rings 0.7–1.8 mm thick), and decreases rapidly from 38 to 47 rings per inch (rings 0.5–0.7 mm thick). The strength at maximum load is not so great with the most rapid-growing wood; it is maximum with from 14 to 20 rings per inch (rings 1.3–1.8 mm thick), and again becomes less as the wood becomes more closely ringed. The natural deduction is that wood of first-class mechanical value shows from 5 to 20 rings per inch (rings 1.3–5 mm thick) and that slower growth yields poorer stock. ', 'wood'),
(49, 'O18191-950-E-K-30105-001', 5, 21, 'In-ring porous', '15', 'NO', '4430', 2, '2019-03-29 09:52:47', NULL, NULL, NULL, 'decreases rapidly from 38 to 47 rings per inch (rings 0.5–0.7 mm thick). The strength at maximum load is not so great with the most rapid-growing wood; it is maximum with from 14 to 20 rings per inch (rings 1.3–1.8 mm thick), and again becomes less as the wood becomes more closely ringed. The natural deduction is that wood of first-class mechanical value shows from 5 to 20 rings per inch (rings 1.3–5 mm thick) and that slower growth yields poorer stock. Thus the inspector or buyer of hickory should discriminate against timber that has more than 20 rings per inch (rings less than 1.3 mm thick).', 'wood'),
(50, 'O18191-950-E-K-30105-001', 5, 22, 'In-diffuse porous', '20', 'No', '4431', 2, '2019-03-29 09:52:47', NULL, NULL, NULL, '20 rings per inch (rings less than 1.3 mm thick', 'wood '),
(51, 'O900-100-A-C-40101-001', 14, 1, 'electric bulb 100watt', '1', 'SET', '4410', 1, '2019-03-30 06:43:47', NULL, NULL, NULL, 'To improve the efficiency of the lamp, the filament usually consists of multiple coils of coiled fine wire, also known as a \'coiled coil\'. Light bulbs using coiled coil filaments are sometimes referred to as \'double-coil bulbs\'. For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'electrical'),
(52, 'O900-100-A-C-40101-001', 51, 2, 'candle flame bulb 60 watt', '1', 'No', '4411', 1, '2019-03-30 06:43:48', NULL, NULL, NULL, '?35 mm (~?11/8\") candle-flame shape, ?12 mm Edison screw', 'electrical'),
(53, 'O900-100-A-C-40101-001', 52, 15, 'electric bulb 60 watt', '1', '1', '4424', 1, '2019-03-30 06:43:48', NULL, NULL, NULL, ' For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'electrical'),
(54, 'O900-101-A-C-40101-002', 15, 6, 'computer', '1', 'No', '4415', 1, '2019-03-30 06:44:34', NULL, NULL, NULL, 'DDR3 ram 4GB,HDD,Core duo-processor ', 'computer'),
(55, 'O900-102-A-C-40101-003', 16, 12, 'bulknanostructured material', '0', 'No', '4421', 1, '2019-03-30 06:45:42', NULL, NULL, NULL, 'Box-shaped graphene (BSG) nanostructure is an example of 3D nanomaterial.[36] BSG nanostructure has appeared after mechanical cleavage of pyrolytic graphite. This nanostructure is a multilayer system of parallel hollow nanochannels located along the surface and having quadrangular cross-section. The thickness of the channel walls is approximately equal to 1 nm. The typical width of channel facets makes about 25 nm.', 'nanomaterials'),
(56, 'O900-102-A-C-40101-003', 55, 11, '2-D nano', '1', 'set', '4420', 1, '2019-03-30 06:45:42', NULL, NULL, NULL, '2D materials are crystalline materials consisting of a two-dimensional single layer of atoms. The most important representative graphene was discovered in 2004. Thin films with nanoscale thicknesses are considered nanostructures, but are sometimes not considered nanomaterials because they do not exist separately from the substrate.', 'nanomaterials'),
(57, 'O900-102-A-C-40101-003', 56, 10, '1-D nano', '10', '--', '4419', 1, '2019-03-30 06:45:42', NULL, NULL, NULL, 'The smallest possible crystalline wires with cross-section as small as a single atom can be engineered in cylindrical confinement. Carbon nanotubes, a natural semi-1D nanostructure, can be used as a template for synthesis. Confinement provides mechanical stabilization and prevents linear atomic chains from disintegration; other structures of 1D nanowires are predicted to be mechanically stable even upon isolation from the templates.\n\n', 'nanomaterials'),
(58, 'O900-103-A-C-40101-004', 17, 1, 'electric bulb 100watt', '15', 'SET', '4410', 1, '2019-03-30 13:22:44', NULL, NULL, NULL, 'To improve the efficiency of the lamp, the filament usually consists of multiple coils of coiled fine wire, also known as a \'coiled coil\'. Light bulbs using coiled coil filaments are sometimes referred to as \'double-coil bulbs\'. For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'electrical'),
(59, 'O900-103-A-C-40101-004', 58, 2, 'candle flame bulb 60 watt', '10', 'No', '4411', 1, '2019-03-30 13:22:44', NULL, NULL, NULL, '?35 mm (~?11/8\") candle-flame shape, ?12 mm Edison screw', 'electrical'),
(60, 'O900-103-A-C-40101-004', 59, 15, 'electric bulb 60 watt', '11', '1', '4424', 1, '2019-03-30 13:22:44', NULL, NULL, NULL, ' For a 60-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'electrical'),
(61, 'O900-103-A-C-40101-004', 60, 16, 'led bulb 100 watt', '17', 'set', '4425', 1, '2019-03-30 13:22:45', NULL, NULL, NULL, ' For a 100-watt 120-volt lamp, the uncoiled length of the tungsten filament is usually 22.8 inches (580 mm)', 'electrical ');
...
CREATE TABLE `Ilab_master_pr_process_detail` (
  ...
  `technical_user_slno` varchar(255) DEFAULT NULL,
  `technical_user_id` varchar(255) DEFAULT NULL,
  ...
  `technical_type_bid` varchar(255) DEFAULT NULL COMMENT '1-simple 2-closed 3-rank order',
  ...
  `commercial_user_slno` varchar(255) DEFAULT NULL,
  ...
  `commercial_type_bid` varchar(255) DEFAULT NULL COMMENT '1-simple 2-closed 3-rank order',
  ...
  `commercial_resubmit_status` int(11) NOT NULL DEFAULT '0' COMMENT '0-no resubmit 1-resubmit',
...
(4, 'O18191-950-E-K-30104-001', '1', 'project 1', '4', 'design2@ilab.com', '10', 1, '2019-03-16', 'siprah@gmail.com', '18', 1, '2019-03-28', 2, 'pro@ilab.com', '13', 1, '2019-03-30', 'buy1@ilab.com', '15', 2, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, '0', '0', 0, 2, 0, NULL, NULL, NULL, NULL, NULL, '0', '0', 0, 0, NULL, 0, 0, 2, NULL, 0, NULL, NULL),
...
(12, 'O18191-950-E-K-30112-001', '1', 'project 1', '12', 'design2@ilab.com', '10', 1, '2019-03-29', 'siprah@gmail.com', '18', 1, '2019-03-29', 1, 'pro@ilab.com', '13', 1, '2019-03-29', 'buy1@ilab.com', '15', 3, NULL, '2019-03-29', NULL, NULL, '19', 'abc@ilab.com', '9956009', '770089', '1', 'Closed Bid', 0, 2, 2, NULL, NULL, NULL, '9956009', '770089', '0', NULL, 0, 0, NULL, 0, 0, 2, NULL, 3, 3, NULL),
(13, 'O18191-950-E-K-30113-001', '1', 'project 1', '13', 'design2@ilab.com', '10', 1, '2019-03-29', 'siprah@gmail.com', '18', 1, '2019-03-29', 1, 'pro@ilab.com', '13', 1, '2019-03-29', 'buy1@ilab.com', '15', 3, NULL, '2019-03-29', NULL, NULL, '19', 'abc@ilab.com', '9909123', '1221200', '1', 'Simple Bid', 0, 2, 2, NULL, NULL, NULL, '9909123', '1221200', '0', NULL, 0, 0, NULL, 0, 0, 2, NULL, 3, 2, NULL),
(14, 'O900-100-A-C-40101-001', '1', 'project 1', '14', 'design2@ilab.com', '10', 3, '2019-03-30', 'siprah@gmail.com', '18', 2, NULL, 2, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, 0, 2, 0, NULL, NULL, NULL, NULL, NULL, '0', NULL, 0, 0, NULL, 0, 0, 2, NULL, 0, NULL, NULL),
(15, 'O900-101-A-C-40101-002', '1', 'project 1', '15', 'design2@ilab.com', '10', 1, '2019-03-30', 'siprah@gmail.com', '18', 1, '2019-03-30', 2, 'pro@ilab.com', '13', 1, '2019-03-30', 'buy1@ilab.com', '15', 6, NULL, NULL, '2019-03-30', NULL, NULL, NULL, NULL, NULL, '0', NULL, 0, 2, 0, NULL, 'commerical@ilab.com', '21', '3022', '550', '1', 'Closed Bid', 2, 0, NULL, 0, 0, 2, NULL, 2, NULL, 5),
(16, 'O900-102-A-C-40101-003', '1', 'project 1', '16', 'design2@ilab.com', '10', 1, '2019-03-30', 'siprah@gmail.com', '18', 1, '2019-03-30', 2, 'pro@ilab.com', '13', 1, '2019-03-30', 'buy1@ilab.com', '15', 6, NULL, NULL, '2019-03-30', NULL, NULL, NULL, NULL, NULL, '0', NULL, 0, 2, 0, NULL, 'commerical@ilab.com', '21', '7701', '66400', '1', 'Simple Bid', 2, 0, NULL, 0, 0, 2, NULL, 2, NULL, 4),
(17, 'O900-103-A-C-40101-004', '1', 'project 1', '17', 'design2@ilab.com', '10', 1, '2019-03-30', 'siprah@gmail.com', '18', 1, '2019-03-30', 1, 'pro@ilab.com', '13', 1, '2019-03-30', 'buy1@ilab.com', '15', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, 0, 2, 0, NULL, NULL, NULL, NULL, NULL, '0', NULL, 0, 0, NULL, 0, 0, 2, NULL, 0, NULL, NULL);
...
(5, 'Electrical', 'O18191-950-E-K-30105-001', NULL, 'TPD for 11KV AIS Switch Board', 'Set', '1', '1', 1, 0, 1, '2019-03-07 12:27:13', '2019-03-29 09:52:47', '2018-12-31', '2019-03-29', 'a:3:{s:9:\"id_master\";s:1:\"5\";s:8:\"id_clone\";i:17;s:10:\"date_entry\";s:10:\"2019-03-29\";}', NULL, 'bu1@ilab.com', NULL, NULL),
...
(12, 'Electrical', 'O18191-950-E-K-30112-001', NULL, 'TPD for 415V LT Smart MCC', 'Set', '6', '1', 1, 0, 1, '2019-03-07 12:27:13', '2019-03-29 09:33:38', '2019-01-15', '2019-03-29', 'a:3:{s:9:\"id_master\";i:43;s:8:\"id_clone\";i:15;s:10:\"date_entry\";s:10:\"2019-03-29\";}', NULL, 'bu1@ilab.com', NULL, NULL),
(13, 'Electrical', 'O18191-950-E-K-30113-001', NULL, 'TPD for 415V PDB', 'Set', '2', '1', 1, 1, 1, '2019-03-07 12:27:13', '2019-03-29 09:36:55', '2019-02-22', '2019-03-29', 'a:3:{s:9:\"id_master\";i:47;s:8:\"id_clone\";i:16;s:10:\"date_entry\";s:10:\"2019-03-29\";}', NULL, 'bu1@ilab.com', '[{\"slno_id\":7,\"date_id\":\"2019-03-09\"}]', '2019-03-09'),
(14, 'Mech', 'O900-100-A-C-40101-001', NULL, 'TSHfor 55KV HT Switch board', 'Set', '10', '1', 1, 0, 1, '2019-03-30 06:23:17', '2019-03-30 06:43:48', '1900-01-30', '2019-03-30', 'a:3:{s:9:\"id_master\";i:53;s:8:\"id_clone\";i:18;s:10:\"date_entry\";s:10:\"2019-03-30\";}', NULL, 'bu1@ilab.com', NULL, NULL),
(15, 'Eec', 'O900-101-A-C-40101-002', NULL, 'TPD for 421V PDB', 'Nr', '25', '1', 1, 0, 1, '2019-03-30 06:23:17', '2019-03-30 06:44:34', '1900-01-28', '2019-03-30', 'a:3:{s:9:\"id_master\";i:54;s:8:\"id_clone\";i:19;s:10:\"date_entry\";s:10:\"2019-03-30\";}', NULL, 'bu1@ilab.com', NULL, NULL),
(16, 'E & T', 'O900-102-A-C-40101-003', NULL, 'TPD for 55V PDB', 'Nr', '33', '1', 1, 0, 1, '2019-03-30 06:23:17', '2019-03-30 06:45:42', '1900-01-30', '2019-03-30', 'a:3:{s:9:\"id_master\";i:57;s:8:\"id_clone\";i:20;s:10:\"date_entry\";s:10:\"2019-03-30\";}', NULL, 'bu1@ilab.com', NULL, NULL),
(17, 'Eec', 'O900-103-A-C-40101-004', NULL, 'TSHfor 56KV HT Switch board', 'Nr', '20', '1', 1, 0, 1, '2019-03-30 06:23:17', '2019-03-30 13:22:45', '1900-01-13', '2019-03-30', 'a:3:{s:9:\"id_master\";i:61;s:8:\"id_clone\";i:21;s:10:\"date_entry\";s:10:\"2019-03-30\";}', NULL, 'bu1@ilab.com', NULL, NULL),
(18, 'E & T', 'O900-104-A-C-40101-005', NULL, 'TSHfor 33KV HT Switch board', 'Set', '15', '1', 1, 0, 0, '2019-03-30 06:23:17', '2019-03-30 06:23:17', '1900-01-30', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(19, 'Mech', 'O900-105-A-C-40101-006', NULL, 'TPD for 419V PDB', 'Nr', '4', '1', 1, 0, 0, '2019-03-30 06:23:17', '2019-03-30 06:23:17', '1900-01-25', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(20, 'Cse', 'O900-106-A-C-40101-007', NULL, 'TSHfor 440KV HT Mach', 'Nr', '40', '1', 1, 0, 0, '2019-03-30 06:23:17', '2019-03-30 06:23:17', '1900-01-07', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(21, 'Cse', 'O900-107-A-C-40101-007', NULL, 'TPD for 431V PDB', 'Nr', '7', '1', 1, 0, 0, '2019-03-30 06:23:17', '2019-03-30 06:23:17', '1900-01-30', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(22, 'Cse', 'O900-108-A-C-40101-008', NULL, 'TPD for 455V PDB', 'Set', '8', '1', 1, 0, 0, '2019-03-30 06:23:17', '2019-03-30 06:23:17', '1900-01-30', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(23, 'EEC', 'O901-200-A-C-40101-001', NULL, 'TTHSfor 55KV HT Switch board', 'set', '40', '1', 1, 0, 0, '2019-03-30 06:40:47', '2019-03-30 06:40:47', '1900-01-05', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(24, 'E&T', 'O902-100-A-C-40101-001', NULL, 'TTHSfor 50KV HT Switch board', 'nr', '20', '1', 1, 0, 0, '2019-03-30 06:40:47', '2019-03-30 06:40:47', '1900-01-04', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(25, 'E&T', 'O903-100-A-C-40101-001', NULL, 'TTHSfor 33KV HT Switch board', 'nr', '150', '1', 1, 0, 0, '2019-03-30 06:40:47', '2019-03-30 06:40:47', '1900-01-07', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(26, 'E&T', 'O904-100-A-C-40101-001', NULL, 'TTHSfor 60KV HT Switch board', 'set', '5', '1', 1, 0, 0, '2019-03-30 06:40:48', '2019-03-30 06:40:48', '1900-01-25', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(27, 'E&T', 'O905-100-A-C-40101-001', NULL, 'TTHSfor 70KV HT Switch board', 'nr', '230', '1', 1, 0, 0, '2019-03-30 06:40:48', '2019-03-30 06:40:48', '1900-01-05', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(28, 'E&T', 'O906-100-A-C-40101-001', NULL, 'TTHSfor 100KV HT Switch board', 'set', '4', '1', 1, 0, 0, '2019-03-30 06:40:48', '2019-03-30 06:40:48', '1900-01-13', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(29, 'EEC', 'O907-100-A-C-40101-001', NULL, 'TTHSfor 55KV HT Switch board', 'nr', '300', '1', 1, 0, 0, '2019-03-30 06:40:48', '2019-03-30 06:40:48', '1900-01-05', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(30, 'EEC', 'O908-100-A-C-40101-001', NULL, 'TTHSfor 33KV HT Switch board', 'nr', '200', '1', 1, 0, 0, '2019-03-30 06:40:48', '2019-03-30 06:40:48', '1900-01-05', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL),
(31, 'EEC', 'O909-100-A-C-40101-001', NULL, 'TTHSfor 10KV HT Switch board', 'set', '50', '1', 1, 0, 0, '2019-03-30 06:40:48', '2019-03-30 06:40:48', '1900-01-03', NULL, NULL, NULL, 'bu1@ilab.com', NULL, NULL);
...
(16, '1', '2019-03-30-114631-Sample_PR_Sched (6).xlsx', 'bu1@ilab.com', '2019-03-30 06:16:31', '2019-03-30 06:16:31'),
(17, '1', '2019-03-30-115317-Sample101.xlsx', 'bu1@ilab.com', '2019-03-30 06:23:17', '2019-03-30 06:23:17'),
(18, '1', '2019-03-30-115332-Sample101.xlsx', 'bu1@ilab.com', '2019-03-30 06:23:32', '2019-03-30 06:23:32'),
(19, '1', '2019-03-30-121047-sample222.ods', 'bu1@ilab.com', '2019-03-30 06:40:47', '2019-03-30 06:40:47');
...
(539, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-26', '10:12:14', 1, NULL, NULL, 'nojdbctarmmlcagq7i050dtdltk46jpg'),
(540, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-26', '11:16:20', 1, NULL, NULL, 'geaodf2jjigce7l73tjpq56vle5ichlm'),
(541, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-26', '11:52:23', 1, NULL, NULL, '234v787r8rduqjqdhj1jsvf005qp42dt'),
(542, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-26', '15:01:53', 1, NULL, NULL, 'aec6rr57mlmskllibovp8tljldnnqflu'),
...
(599, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '10:23:17', 1, NULL, NULL, '7r1b4pjpir098j8amse8admgt1oesp61'),
(600, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '12:11:43', 2, '12:12:15', '2019-03-29', '2hrrdcm660qvn0vs33i69l1ai2mv7u8p'),
(601, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '12:12:28', 1, NULL, NULL, 'shfsp1lc21edm5emp90663r5tbkv7kuc'),
(602, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:02:09', 2, '15:03:42', '2019-03-29', 'thn8knitoveumf57js9hod36ioq7lj1e'),
(603, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:06:00', 2, '15:07:03', '2019-03-29', '6fsq5el98auu6iaebdthjllahj9qdcf1'),
(604, 'siprah@gmail.com', 'Approver5', 8, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:07:29', 2, '15:08:42', '2019-03-29', '2m456a3cuvgp38mpm3sle0ijvk64mqt3'),
(605, 'pro@ilab.com', 'procurement user 1', 4, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:09:10', 2, '15:10:07', '2019-03-29', '4p52f7hd5stu1fh9rmcplik85uk47gst'),
(606, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:10:29', 2, '15:14:05', '2019-03-29', '3hhg83km5eu4k6hjbbuo6tp29lejo1c7'),
(607, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:15:15', 1, NULL, NULL, 'mi07e3k1cj78vhcrfprrf6704ta58it4'),
(608, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:21:06', 2, '15:22:52', '2019-03-29', 'iq9ri1qmaigdmo1lnueo5ln907caaegh'),
(609, 'siprah@gmail.com', 'Approver5', 8, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:23:11', 2, '15:23:54', '2019-03-29', 'ctfok8v6vor20rujta9n85mi96n1asnp'),
(610, 'pro@ilab.com', 'procurement user 1', 4, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:24:15', 2, '15:25:19', '2019-03-29', '7h5q4god7atff7tv2dhvh06mpam17msg'),
(611, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:25:56', 2, '15:28:38', '2019-03-29', 'oc5ddg8uj76hp3is1ms6ciu55r24e8gq'),
(612, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:33:54', 2, '15:34:20', '2019-03-29', 'dgs1d33nasiignqe5milai9b7p4vbu95'),
(613, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:34:46', 1, NULL, NULL, '6nqsmbr07a2u5shlcrkm7ndda34qspr3'),
(614, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-29', '15:45:26', 1, NULL, NULL, 'jranmok5m16dsuj0ckvqqk7aj9dhd1lv'),
(615, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-29', '19:53:40', 1, NULL, NULL, 'ptmtrh9pjgamft15lrp53ma4moc1nn5j'),
(616, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '10:33:34', 1, NULL, NULL, '6bggtssacef9vcoa81kkbh0bitckc883'),
(617, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '10:40:33', 1, NULL, NULL, 'bhbnat72dt6n2889h85gic79ku66v86u'),
(618, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '10:41:59', 2, '10:43:38', '2019-03-30', 'rqu8krrd67udhhbi9no1j8martj7718i'),
(619, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '10:43:56', 1, NULL, NULL, 'tn660dvfa6nrutteelddjjf87g87sa79'),
(620, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '11:02:14', 1, NULL, NULL, 'm7fs6am55d2pe5dlnm09rajv74t8kuaj'),
(621, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '11:03:58', 1, NULL, NULL, 'dk8ktjarjqjheeqr5lakl3me9vvesj33'),
(622, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '11:09:47', 1, NULL, NULL, 'sa393ab5ptqhdnrs6jec41nh6piatjjl'),
(623, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-30', '11:13:30', 1, NULL, NULL, 'kvjnmcem9hahu065oughn9u1l3ldvibf'),
(624, 'bu1@ilab.com', 'bu user1', 6, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '11:18:55', 1, NULL, NULL, 'tdrojujukdfuj0mu9n6ghmmkshkfjt0u'),
(625, 'bu1@ilab.com', 'bu user1', 6, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '11:47:23', 1, NULL, NULL, '4bac0ecld1oig9q5fk1n53isui0gidbd'),
(626, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:12:47', 2, '12:15:49', '2019-03-30', 'e9krv20tpfoa0ebu6rihp6s38el7kf36'),
(627, 'siprah@gmail.com', 'Approver5', 8, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:16:07', 2, '12:17:21', '2019-03-30', 'vl2pjte4ognj33k2s11mlshredfoo8lv'),
(628, 'pro@ilab.com', 'procurement user 1', 4, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:17:49', 2, '12:18:47', '2019-03-30', 'jkseashdo905em2667rr9eosbcugdrtb'),
(629, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:19:24', 1, NULL, NULL, 'e0tb0odpsc4j38elt5c0gvb5ar508mth'),
(630, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:23:27', 1, NULL, NULL, 'er9ddbu79h4d795esmf2rcbs1qo2mg6b'),
(631, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:30:45', 1, NULL, NULL, 'cat219nm24jurtoscaq969najq6gi2fa'),
(632, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:40:46', 1, NULL, NULL, 'ev42g8m7ganoktm4p3k6ufhnm72lgo28'),
(633, 'commerical@ilab.com', 'user3', 10, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:42:34', 1, NULL, NULL, 'h1450anjdl4amm5gjuer6918l23u0iod'),
(634, 'commerical@ilab.com', 'user3', 10, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '12:44:04', 1, NULL, NULL, '2v2094ruob44c2d5798cl6d11cis941m'),
(635, 'commerical@ilab.com', 'user3', 10, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '13:12:47', 1, NULL, NULL, '2vv6he9ova7to1he3i43fk72v0gpsf3c'),
(636, 'abc@ilab.com', 'Technical User', 9, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '13:16:53', 1, NULL, NULL, 'n33ve0bhl8oum80us3kr97u6tvhbqoe1'),
(637, 'commerical@ilab.com', 'user3', 10, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '13:18:00', 1, NULL, NULL, 'hnlc7lvcnairck7susbbdbsj3brd6eu0'),
(638, 'commerical@ilab.com', 'user3', 10, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.4', '2019-03-30', '14:45:54', 1, NULL, NULL, 'p5bebnclbmp881ivcemsppe3d6abvpih'),
(639, 'commerical@ilab.com', 'user3', 10, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.6', '2019-03-30', '17:12:47', 1, NULL, NULL, '4cn1c3s1og5i2ghqbfvhirrg5f3csv5a'),
(640, 'commerical@ilab.com', 'user3', 10, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.6', '2019-03-30', '17:58:58', 1, NULL, NULL, '3pfak9deagvd75pcpkmej1rrj3f0cgco'),
(641, 'bu1@ilab.com', 'bu user1', 6, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.6', '2019-03-30', '18:51:06', 2, '18:51:28', '2019-03-30', 'g64pfct1v5evl1aqnvpsm2hv2do19obj'),
(642, 'design2@ilab.com', 'design user 2', 2, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.6', '2019-03-30', '18:51:39', 2, '18:52:54', '2019-03-30', 'rj8jm1g7nmg247a7fp2h3igt522htv3s'),
(643, 'siprah@gmail.com', 'Approver5', 8, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.6', '2019-03-30', '18:53:05', 2, '18:53:45', '2019-03-30', 'kiiu24lekmjkirku0tav64a8prm0s36d'),
(644, 'pro@ilab.com', 'procurement user 1', 4, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.6', '2019-03-30', '18:54:02', 2, '18:54:26', '2019-03-30', 'pd8hpoin40ognet68269j37g5hu9cc9v'),
(645, 'buy1@ilab.com', 'buyer 1', 7, '{\"browser\":\"Chrome\",\"browserVersion\":\"72.0.3626.121\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Linux x86_64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/72.0.3626.121 Safari\\/537.36\"}', '192.168.0.6', '2019-03-30', '18:54:56', 1, NULL, NULL, 'qb243q4ekt20efmnb0ujf8dm97upkev5');
...
(68, 'ven121@gmail.com', 'INFOLEX METAMORF ', 4, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-29', '13:08:44', 1, NULL, NULL, 'r0o8pugbjsl8ihip5nr86k29eql8ebv8'),
(69, 'ven121@gmail.com', 'INFOLEX METAMORF ', 4, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-30', '11:31:14', 1, NULL, NULL, 'a0cfvsunpchh740jp9fj9r84nbhchim3'),
(70, 'ven121@gmail.com', 'INFOLEX METAMORF ', 4, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-30', '14:10:21', 1, NULL, NULL, 'noj4c1avq4pit19peql48gc8c4bpaeq7'),
(71, 'ven121@gmail.com', 'INFOLEX METAMORF ', 4, '{\"browser\":\"Chrome\",\"browserVersion\":\"73.0.3683.86\",\"platform\":\"Windows 8.1\",\"full_user_agent_string\":\"Mozilla\\/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit\\/537.36 (KHTML, like Gecko) Chrome\\/73.0.3683.86 Safari\\/537.36\"}', '192.168.0.7', '2019-03-30', '14:22:59', 1, NULL, NULL, '3k7d9f9s3qk35lqv6nc5ggc4r8c0rk5g'),
(72, 'ven121@gmail.com', 'INFOLEX METAMORF ', 4, '{\"browser\":\"Firefox\",\"browserVersion\":\"66.0\",\"platform\":\"Linux\",\"full_user_agent_string\":\"Mozilla\\/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko\\/20100101 Firefox\\/66.0\"}', '192.168.0.3', '2019-03-30', '17:29:19', 1, NULL, NULL, '5ube5g1rintfqibrunodtau58ujel4i3');
...
--
-- Table structure for table `Ilab_master_vendor_file_token_c`
--

CREATE TABLE `Ilab_master_vendor_file_token_c` (
  `slno_tech_file` int(11) NOT NULL,
  `token_id` varchar(255) NOT NULL,
  `master_bid_id` int(11) NOT NULL,
  `vendor_id` varchar(255) NOT NULL,
...
--
-- Dumping data for table `Ilab_master_vendor_file_token_c`
--

INSERT INTO `Ilab_master_vendor_file_token_c` (`slno_tech_file`, `token_id`, `master_bid_id`, `vendor_id`, `file_name`, `file_attach`, `status`, `date_entry`, `time_entry`, `bid_user_slno`, `pr_no`) VALUES
(2, 'eEPklcrI', 1, 'ven121@gmail.com', 'pre', '2019-03-29-Screenshot from 2018-09-13 17-21-59.png', 1, '2019-03-29', '18:34:42', 3, 'O18191-950-E-K-30108-001'),
(3, 'eEPklcrI', 1, 'ven121@gmail.com', 'profile', '2019-03-29-View System User.xlsx', 1, '2019-03-29', '19:13:15', 3, 'O18191-950-E-K-30108-001'),
(4, 'Biar3YOe', 1, 'ven121@gmail.com', 'new process', '2019-03-30-images.jpeg', 1, '2019-03-30', '11:32:16', 3, 'O18191-950-E-K-30108-001'),
(5, 'Biar3YOe', 1, 'ven121@gmail.com', 'profile', '2019-03-30-cat_walk_by_elenadudina_dcx60l2-pre.jpg', 1, '2019-03-30', '11:32:34', 3, 'O18191-950-E-K-30108-001');
...
CREATE TABLE `Ilab_master_vendor_notifications` (
  `slno_approve` int(11) NOT NULL,
  `vendor_id_bid` varchar(255) DEFAULT NULL,
  `vendor_id` varchar(255) NOT NULL,
  `date_entry` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `date_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(22, '1', 'vender2@ilab.com', '2019-03-29 09:43:58', '2019-03-29 09:43:58', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 1221200 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(23, '2', 'vender@ilab.com', '2019-03-29 09:43:58', '2019-03-29 09:43:58', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 1221200 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(24, '4', 'ven121@gmail.com', '2019-03-29 09:43:58', '2019-03-29 09:43:58', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 1221200 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(25, '8', 'ven1011@yahoo.com', '2019-03-29 09:43:58', '2019-03-29 09:43:58', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 1221200 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(26, '12', 'ven90@gmail.com', '2019-03-29 09:43:58', '2019-03-29 09:43:58', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 1221200 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(27, '1', 'vender2@ilab.com', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 770089 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-25\n'),
(28, '2', 'vender@ilab.com', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 770089 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-25\n'),
(29, '4', 'ven121@gmail.com', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 770089 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-25\n'),
(30, '7', 'ven310@yahoo.com', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 770089 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-25\n'),
(31, '8', 'ven1011@yahoo.com', '2019-03-29 09:58:30', '2019-03-29 09:58:30', 0, 'New Bid Is been Publish on 29-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 770089 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-25\n'),
(32, '1', 'vender2@ilab.com', '2019-03-30 07:08:00', '2019-03-30 07:08:00', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 66400 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(33, '2', 'vender@ilab.com', '2019-03-30 07:08:00', '2019-03-30 07:08:00', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 66400 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(34, '4', 'ven121@gmail.com', '2019-03-30 07:08:00', '2019-03-30 07:08:00', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 66400 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(35, '7', 'ven310@yahoo.com', '2019-03-30 07:08:00', '2019-03-30 07:08:00', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 66400 And Bid Type Is Simple Bid Bid will Be Closed On Date 2019-04-26\n'),
(36, '1', 'vender2@ilab.com', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 550 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-19\n'),
(37, '2', 'vender@ilab.com', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 550 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-19\n'),
(38, '4', 'ven121@gmail.com', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 550 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-19\n'),
(39, '7', 'ven310@yahoo.com', '2019-03-30 07:10:15', '2019-03-30 07:10:15', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Commerical New Bid Information Bid Reference Id is 550 And Bid Type Is Closed Bid Bid will Be Closed On Date 2019-04-19\n'),
(40, '4', 'ven121@gmail.com', '2019-03-30 13:28:23', '2019-03-30 13:28:23', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 68009 And Bid Type Is Simple Bid Bid will Be Closed On Date 2018-12-27\n'),
(41, '2', 'vender@ilab.com', '2019-03-30 13:28:23', '2019-03-30 13:28:23', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 68009 And Bid Type Is Simple Bid Bid will Be Closed On Date 2018-12-27\n'),
(42, '1', 'vender2@ilab.com', '2019-03-30 13:28:23', '2019-03-30 13:28:23', 0, 'New Bid Is been Publish on 30-03-2019 Please Check Information Under Technical New Bid Information Bid Reference Id is 68009 And Bid Type Is Simple Bid Bid will Be Closed On Date 2018-12-27\n');
...
--
-- Table structure for table `Ilab_master_vendor_tech_token_bid_c`
--

CREATE TABLE `Ilab_master_vendor_tech_token_bid_c` (
  `Slno_token` int(11) NOT NULL,
  `token_no` varchar(255) NOT NULL,
  `bid_id_vendor` varchar(255) NOT NULL,
  `master_bid_id` int(11) NOT NULL,
...
--
-- Dumping data for table `Ilab_master_vendor_tech_token_bid_c`
--

INSERT INTO `Ilab_master_vendor_tech_token_bid_c` (`Slno_token`, `token_no`, `bid_id_vendor`, `master_bid_id`, `vendor_id`, `submitted_status`, `date_creation`, `date_updation`, `comment`, `pr_no`) VALUES
(1, 'eEPklcrI', '3', 1, 'ven121@gmail.com', 0, '2019-03-29', '2019-03-29 12:15:03', NULL, 'O18191-950-E-K-30108-001'),
(2, 'Biar3YOe', '3', 1, 'ven121@gmail.com', 1, '2019-03-30', '2019-03-30 06:31:03', NULL, 'O18191-950-E-K-30108-001'),
(3, 'k4iL6wFT', '8', 2, 'ven121@gmail.com', 0, '2019-03-30', '2019-03-30 07:23:58', NULL, 'O18191-950-E-K-30113-001'),
(4, '2qbkOn7v', '8', 2, 'ven121@gmail.com', 0, '2019-03-30', '2019-03-30 07:26:22', NULL, 'O18191-950-E-K-30113-001');
...
--
-- Indexes for table `Ilab_master_bid_t_c_comm_m`
--
ALTER TABLE `Ilab_master_bid_t_c_comm_m`
  ADD PRIMARY KEY (`slno`);

--
-- Indexes for table `Ilab_master_bid_t_c_tech_m`
--
...
--
-- Indexes for table `Ilab_master_vendor_file_token_c`
--
ALTER TABLE `Ilab_master_vendor_file_token_c`
  ADD PRIMARY KEY (`slno_tech_file`);
...
--
-- Indexes for table `Ilab_master_vendor_tech_token_bid_c`
--
ALTER TABLE `Ilab_master_vendor_tech_token_bid_c`
  ADD PRIMARY KEY (`Slno_token`);
...
--
ALTER TABLE `Ilab_master_bid_Com_date_details_m`
  MODIFY `Slno_bid_date` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `Ilab_master_bid_Com_details_m`
--
ALTER TABLE `Ilab_master_bid_Com_details_m`
  MODIFY `slno_bid_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `Ilab_master_bid_Com_evaluation_m`
--
ALTER TABLE `Ilab_master_bid_Com_evaluation_m`
  MODIFY `slno_bid_tech_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `Ilab_master_bid_Com_m`
--
ALTER TABLE `Ilab_master_bid_Com_m`
  MODIFY `Slno_bid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `Ilab_master_bid_date_details_m`
  MODIFY `Slno_bid_date` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `Ilab_master_bid_details_m`
  MODIFY `slno_bid_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `Ilab_master_bid_m`
  MODIFY `Slno_bid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `Ilab_master_bid_technicalevaluation_m`
  MODIFY `slno_bid_tech_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `Ilab_master_mr_file_upload_m`
  MODIFY `slno_file` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `Ilab_master_mr_job_details_m`
  MODIFY `slno_mr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `Ilab_master_mr_job_details_m_clone`
--
ALTER TABLE `Ilab_master_mr_job_details_m_clone`
  MODIFY `slno_mr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `Ilab_master_mr_material_item_comm_m`
  MODIFY `slno_item_mr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `Ilab_master_mr_material_item_m`
--
ALTER TABLE `Ilab_master_mr_material_item_m`
  MODIFY `slno_item_mr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
--
...
--
ALTER TABLE `Ilab_master_pr_schedule_file`
  MODIFY `slno_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
...
--
ALTER TABLE `Ilab_master_session_history`
  MODIFY `slno_history` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=646;
--
-- AUTO_INCREMENT for table `Ilab_master_session_history_vendors`
--
ALTER TABLE `Ilab_master_session_history_vendors`
  MODIFY `slno_history` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
...
--
-- AUTO_INCREMENT for table `Ilab_master_vendor_file_token_c`
--
ALTER TABLE `Ilab_master_vendor_file_token_c`
...
--
ALTER TABLE `Ilab_master_vendor_notifications`
  MODIFY `slno_approve` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
...
--
-- AUTO_INCREMENT for table `Ilab_master_vendor_tech_token_bid_c`
--
ALTER TABLE `Ilab_master_vendor_tech_token_bid_c`
  MODIFY `Slno_token` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
